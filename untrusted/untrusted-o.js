(() => {
  ...
  var A = {
        ...
        function s(A, s) {
          for (var i = {}, r = [], a = 0; a < A.length; a++) {
            ...
            if (-1 !== d) (t[d].references++, t[d].updater(h));
              ...
              var b = n(h, s);
              ((s.byIndex = a),
                t.splice(a, 0, { identifier: g, updater: b, references: 1 }));
            }
            r.push(g);
          }
          return r;
      ...
      37: (A) => {
        ...
        function s(A, t, s, n) {
          ...
          if (A.styleSheet) A.styleSheet.cssText = e(t, i);
          else {
        ...
        var n = { singleton: null, singletonCounter: 0 };
        A.exports = function (A) {
  ...
  function e(s) {
    ...
    var i = (t[s] = { id: s, exports: {} });
    return (A[s](i, i.exports, e), i.exports);
  }
  ((e.n = (A) => {
    ...
    (() => {
      ...
      function l() {
        return {
          getData: (e) =>
            location.origin == t && null != n && e in n.data_
              ? n.data_[e]
              : A[e],
          getString(A) {
      ...
      const h = {
                    ...
                    (console.log("Received Message in " + location.origin),
                      ...
                      null != t.data.gameStats &&
                        ("" == t.data.gameStats
                          ...
                          : ((this.data = JSON.parse(t.data.gameStats)),
                            this.updateData()),
                        A(!0)));
                  })
                : A(!1);
          ...
          updateHighScores() {
            if (location.origin != t || null == n) return;
            const A = [
              n.data_.old_classic_high_score,
              n.data_.old_speed_high_score,
              n.data_.old_buoy_high_score,
            ];
            ((this.data.highScore.endless = Math.max(
              this.data.highScore.endless,
              A[0],
            )),
              (this.data.highScore.zigzag = Math.max(
                this.data.highScore.zigzag,
                A[2],
              )),
              -1 != A[1] &&
                (this.data.highScore.timetrial = Math.min(
                  this.data.highScore.timetrial,
                  A[1],
                )));
          },
          updateData() {
          ...
          getData() {
            location.origin == t
              ? (window.parent.postMessage({ type: "getGameData" }, s),
                this.data || (this.data = this.createData()))
              : (this.data = this.createData());
          },
          setData() {
            location.origin == t &&
              window.parent.postMessage(
                { type: "saveGameData", stats: JSON.stringify(this.data) },
                s,
              );
          },
          resetData() {
      ...
      class p extends B {
        ...
        draw() {
          this.pickup
            ? X.sys.drawPickup(this)
            : (void 0 !== this.fx &&
                "hidden" !== this.anim &&
                X.sys.drawFx(this.time, this.x, this.y + this.fx),
              X.sys.drawLayer(
                this.type,
                this.pose,
                this.x,
              ...
              void 0 !== this.decor &&
                X.sys.drawLayer("wallDecor", this.decor, this.x, this.y - 24));
        }
      }
      class w extends p {
        constructor(A, t, e, s) {
        ...
        isCrashed() {
          return !(
            this.timer.crash <= 0 ||
            ((this.timer.crash -= hA.sys.game.time.loop),
      ...
      class y extends p {
        ...
        changeState(A) {
          if (this.state !== A) {
            switch (
              ((this.state = A), (this.timer = { crash: 0, direction: 0 }), A)
            ) {
              case "chase":
                break;
              case "crash":
        ...
        updateDirection() {
          if (
            ((this.dist = Math.hypot(
              hA.sys.session.x - this.x,
              hA.sys.session.y - this.y,
            )),
            (this.timer.direction -= hA.sys.game.time.loop),
            this.timer.direction <= 0)
          ) {
            this.timer.direction +=
              (i(25, 100) / 100) * (this.dist / hA.sys.session.y);
      ...
      const m = {
          ...
          createButton(A, t = "Button", e) {
            ...
            return (
              ...
              s.addEventListener("click", function (A) {
                (m.clickEffect(A, s), m.focusGroup(s));
              }),
          ...
          createTextButton(A, t, e, s) {
            ...
            return (
              (this.create("span", n).textContent = t),
              this.classAdd(n, e),
              n
            );
          },
        ...
        f = {
          ...
          onKeydown(A) {
            ...
            if ((j.sys.changeInput(j.sys.Keys), !this.pressed[t])) {
          ...
          onKeyup(A) {
            const t = A.key.toLowerCase();
            ("tab" === t && j.sys.tabKeyup(A), delete this.pressed[t]);
          },
        },
        x = {
          setup() {
          ...
          onMouseMove(A) {
            if (!hA.sys.isState(dA.Play)) return;
            const t = { x: A.clientX, y: A.clientY },
              e = j.sys.checkAngle(hA.sys.session, t);
            this.last !== e && ((this.last = e), j.sys.routeInput(e, !0));
          },
          onContextMenu(A) {
            (A.preventDefault(),
              j.sys.changeInput(j.sys.Mouse),
        ...
        v = {
          ...
          reset() {
            ((this.last = void 0),
              (this.swipe = 0),
              (this.touch = { down: { x: 0, y: 0 }, move: { x: 0, y: 0 } }));
          },
          onTouchStart(A) {
            if (
              !this.ignored(A) &&
              (j.sys.changeInput(j.sys.Touch), A.targetTouches)
            ) {
          ...
          onTouchMove(A) {
            ...
            if (
              ((this.touch.move = { x: t.clientX, y: t.clientY }),
              hA.sys.isState(dA.Play) && e)
            ) {
              const A = j.sys.checkAngle(hA.sys.session, this.touch.move);
              this.last !== A && ((this.last = A), j.sys.routeInput(A, !0));
            }
          },
          onTouchEnd(A) {
            if (this.ignored(A)) return;
            ...
            (Math.abs(t) < 10 && Math.abs(e) < 10
              ? ((n = !0),
                (s = j.sys.checkAngle(hA.sys.session, this.touch.down)))
              : Date.now() - this.swipe <= 400 &&
                (s = j.sys.checkAngle(this.touch.down, this.touch.move)),
              s &&
                !hA.sys.isState(dA.Menu) &&
                (j.sys.routeInput(s, n), j.sys.checkCheatCode(s)));
          },
          ignored: (A) =>
            !!A.target.closest("button") ||
            (A.cancelable && A.preventDefault(), !1),
        },
        E = {
          setup() {
          ...
          setGamepad(A, t) {
            ((this.linked = { index: A, pad: t, pressed: {} }),
          ...
          routeJoystick(A) {
            this.last !== A &&
              ((this.last = A),
              A && (j.sys.routeInput(A, !0), j.sys.changeInput(j.sys.Gamepad)));
          },
          checkButtons(A) {
            let t;
            for (let s = 0; s < A.buttons.length; s++)
              if ("object" == typeof (e = A.buttons[s]) ? e.pressed : 1 === e) {
                ...
                switch (
                  ((this.linked.pressed[this.button[s]] = !0), this.button[s])
                ) {
                  case "a":
                    t = z.Click;
                    break;
      ...
      var Q, k, I;
      function M(A, e) {
        if (location.origin != t || -1 == e) return;
        const n = { type: A, action: e };
      ...
      const H = l(),
        F = {
          setup() {
            ...
            if ((m.create("span", o, void 0, "flyout-text", l), !d())) {
              const A = m.create("div", this.flyout, void 0, "modal-row"),
              ...
              (e.setAttribute("data-menu", "3"),
                m.clickEvent(
                  e,
                  function () {
                    window.parent.postMessage({ type: "openSidebarApp" }, s);
                  },
                  !0,
                ));
            }
        ...
        U = {
          setup() {
            ...
            (m.create("span", A, void 0, "flyout-title", t),
              ...
              this.addNames(
                "settingsCreditsDesign",
                "Parker Young, William Devereux, Scott Porterfield, Michael Diaz",
              ),
              this.addNames(
          ...
          buildToggle(A, t, e, s) {
            ...
            return (
              ...
              m.clickEvent(i, function () {
                (O.changeToggle(i), O.updateToggle(i));
              }),
              r
            );
          },
      ...
      class T {
        ...
        focusFlyoutElement(A) {
          ...
          A.shiftKey || t.indexOf(e) + 1 !== t.length
            ? A.shiftKey &&
              0 === t.indexOf(e) &&
              (m.focusButton(t[t.length - 1]), A.preventDefault())
            : (m.focusButton(t[0]), A.preventDefault());
        }
      ...
      class R {
        constructor() {
          ...
          ((R.sys = this), this.defineLegend(), this.defineClusters());
        }
        defineLegend() {
          ((this.legend = {
            wall: {
      ...
      class Z {
        ...
        refreshMenuModeCluster() {
          (this.reset(), P.spawnMenuCluster(), this.merge());
        }
        ...
        calcClusterSlots() {
          this.slots =
            2 * Math.ceil((hA.sys.session.h - hA.sys.session.y) / this.gap) + 3;
        }
        update() {
          (this.putToSleep(), P.spawnUpdate(), this.merge());
        }
        passed(A) {
        ...
        ready(A) {
          return !(A.next >= hA.sys.game.dist.unit || ((A.next += A.add), 0));
        }
        ...
        buildCluster(A, t, e, s) {
          s ||
            (s = r(
              Object.keys(R.sys.library[A]).filter(
                (A) => !this.prevClusters.includes(A),
              ),
            ));
        ...
        buildNpc() {
          const A = i(1, 13),
            t = (Math.random() / 2 + 0.25) * hA.sys.session.w,
            e = A < J.entity.speed.raw ? hA.sys.session.h + 24 : -24;
          this.buildObject("npc", t, e, "left").speed.max = A;
        }
        buildFoe() {
          const A = (Math.random() / 2 + 0.25) * hA.sys.session.w;
          this.buildObject("foe", A, -32, "chase").speed.raw =
            J.entity.speed.raw + 1;
        }
        buildCrashedFriend() {
          ...
          const t = P.active;
          t.distance.friend.next =
            hA.sys.game.dist.unit + t.distance.friend.add;
        }
        buildCheckpoint(A, t) {
        ...
        buildLair() {
          ((this.lairBuilt = !0),
            ...
            (this.top = this.sleep(this.top, -64, hA.sys.session.h + 64)));
          const A =
              hA.sys.session.x - (hA.sys.session.h - hA.sys.session.y) - 256,
        ...
        buildObject(A, t, e, s) {
          ...
          switch ((a || (a = this.createObject(A, t, e, s)), a.type)) {
            case "wall":
              !(function (A, t) {
                !["f1", "f2", "f3"].includes(t) &&
                  Math.random() < 0.5 &&
                  (A.decor = r(["a", "b", "c", "d", "e", "f", "g", "h"]));
              })(a, s);
              break;
            case "ambient":
              a.anim = "hidden";
          ...
          return (this[u.sys.sheet[A].group].push(a), a);
        }
        ...
        merge() {
          ...
          function t(A, t) {
            return A.pickup
              ...
              : t.pickup
                ? 1
                : A.hitbox.y + A.hitbox.h - (t.hitbox.y + t.hitbox.h);
          }
          (J.entity.distance.air
            ? (A.sort((A, e) => t(A, e)), A.push(J.entity))
            : (A.push(J.entity), A.sort((A, e) => t(A, e))),
        ...
        wakeFromSleep(A, t) {
          ...
          for (let n = 0; n < s; n++)
            if (e[n].type === A)
              return ((e[n].pose = t), (e = e.splice(n, 1)), e[n]);
          return null;
        }
        putToSleep() {
        ...
        sleep(A, t = -64, e = 1e4) {
          ...
          return (
            (this.sleeping = this.sleeping.concat(s)),
            A.filter((A) => n(A))
          );
          function n(A) {
      ...
      const K = {
          update() {
            ((this.allObjects = this.filterVisible(
              Z.sys.top.concat(Z.sys.btm),
            )),
          ...
          checkFoeObjects() {
            for (let A = 0; A < this.allObjects.length; A++) {
              ...
              this.collision(J.entity, t) &&
                ("lure" === t.type ? (t.hit = !0) : (t.sleep = !0));
            }
          },
          checkPlayerFoes() {
            const A = J.entity;
            ...
            for (let s = 0; s < t; s++) {
              ...
              this.collision(t, A) &&
                ...
                (hA.sys.game.shields.current > 0
                  ? (t.crash(), W.removeShield())
                  : A.isFoe
                    ? t.crash()
                    : (t.ending(), (Z.sys.endingFoe = t), W.gameLose()));
              for (let A = 0; A < e; A++) {
                const e = Z.sys.npc[A];
          ...
          filterVisible: (A) =>
            A.filter((A) =>
              (function (A) {
                return (
                  (A.y > -64 &&
                    A.y < hA.sys.session.h + 64 &&
                    A.x > -64 &&
                    A.x < hA.sys.session.w + 64) ||
                  "gate" === A.type
                );
              })(A),
            ),
        ...
        W = {
          ...
          playerAir(A) {
            (J.entity.air(A), j.sys.feedback("air"));
          },
          playerBoost(A = !1) {
            (!A &&
              (hA.sys.game.boosts.current <= 0 || J.entity.distance.boost)) ||
              (A ||
                hA.sys.game.cheat.boosts ||
                hA.sys.delItem(hA.sys.game.boosts, 1),
              J.entity.boost(),
          ...
          gameLair() {
            (J.entity.changeToFoe(),
              ...
              Z.sys.top
                ...
                .forEach((A) => {
                  (Z.sys.buildObject("foe", A.x, A.y, V.Chase), (A.sleep = !0));
                }),
          ...
          playerCrash() {
            if (J.entity.distance.immune) return;
          ...
          addFriend() {
            J.entity.isFoe ||
              (hA.sys.addItem(hA.sys.game.shields, 3),
              (hA.sys.game.friend = !0),
              X.sys.createPlayerSprite());
          },
          removeFriend() {
            hA.sys.game.friend &&
              !hA.sys.game.cheat.safety &&
              (hA.sys.delItem(hA.sys.game.shields, 3),
              (hA.sys.game.friend = !1),
              Z.sys.buildCrashedFriend(),
              X.sys.createPlayerSprite(),
              (P.active.distance.friend.next =
                hA.sys.game.dist.unit + P.active.distance.friend.add));
          },
          removeShield() {
            (j.sys.feedback("small"),
              hA.sys.game.cheat.safety ||
                hA.sys.delItem(hA.sys.game.shields, 1));
          },
        };
      var z, V;
      !(function (A) {
      ...
      class j {
        ...
        routeInput(A, t = !1) {
          ...
          T.sys.isFlyoutOpen()
            ? this.moveFocus(T.sys.active.flyout, A, "menu")
            : hA.sys.isState(dA.Play)
              ? (!t && this.isDouble(A) && (A = z.Boost),
                J.entity.routeAction(A, t))
        ...
        moveFocus(A, t, e) {
          ...
          if (s || n) {
            const n = document.activeElement,
              ...
              r =
                !!n &&
                "button" === n.nodeName.toLowerCase() &&
                n.dataset.hasOwnProperty(e);
            if (i && i.querySelector(".btn").dataset.hasOwnProperty(e))
              if (s) {
                ...
                const s = Number(
                    i.querySelector(".btn").getAttribute("data-" + e),
                  ),
                  n = t === z.Up ? -1 : 1,
            ...
            } else m.focusButton(A.querySelector("[data-" + e + "='1']"));
          }
        }
        isDouble(A) {
          if (A !== z.Down || J.entity.distance.boost) return !1;
          const t = Date.now(),
        ...
        spacebarEnterKeydown(A) {
          "button" !== document.activeElement.nodeName.toLowerCase() &&
            (A.preventDefault(), m.clickActionButton());
        }
        resetGame() {
          bA.sys.changeState(dA.Menu);
        }
        ...
        checkCheatCode(A) {
          if (!hA.sys.isState(dA.Menu)) return;
          const t = this.isInput(j.sys.Keys)
            ? this.codes.keys
            : this.codes.directional;
      ...
      class J extends p {
        constructor() {
          if (
            (super("player", hA.sys.session.x, hA.sys.session.y, V.Down),
            J.entity)
          )
            return J.entity;
          J.entity = this;
        ...
        move() {}
        unlockForNewGame() {
          (this.reset(), this.changeDirection(V.Down));
        }
        update() {
          (super.update(),
            this.updateAngle(),
            ...
            this.direction === V.Up ||
              this.timer.crash ||
              (this.updateDrift(), this.updateSpeed()));
        }
        routeAction(A, t = !1) {
        ...
        changeDirection(A, t = !1) {
          ...
          switch (
            (t || A !== V.Left
              ? t ||
                A !== V.Right ||
                (A = this.direction === V.DownRight ? V.Right : V.DownRight)
              : (A = this.direction === V.DownLeft ? V.Left : V.DownLeft),
            A)
          ) {
            case V.Left:
              e = -42;
        ...
        changePose(A) {
          (this.isFoe && (A = A === V.Up ? V.Crash : V.Chase), (this.pose = A));
        }
        updateAngle() {
        ...
        updateTimer() {
          this.timer.crash &&
            ((this.timer.crash -=
              hA.sys.game.time.loop * hA.sys.game.time.scale),
            this.timer.crash <= 0 &&
              ((this.timer.crash = void 0), this.endCrash()));
        }
        updateDistance() {
        ...
        down() {
          if (this.distance.air) {
            ...
            (this.changePose(A), j.sys.feedback("small"));
          } else this.changeDirection(V.Down);
        }
        crash() {
          ((this.timer.crash = 1),
            this.stopPlayerSpeed(),
        ...
        endCrash() {
          (this.up(), j.sys.reset(), j.sys.feedback("tiny"));
        }
        endAir() {
        ...
        endBoost() {
          ((this.speed.max = this.speed.base), j.sys.feedback("tiny"));
        }
        slow() {
          ((this.speed.raw *= 0.7), j.sys.feedback("slow"));
        }
        changeToFoe() {
          ((this.isFoe = !0),
        ...
        spin() {
          ...
          ((this.speed.raw *= 0.9), j.sys.feedback("slow"));
        }
        gameOver() {
        ...
        updateLineFx() {
          (this.moveLines(this.boostFx, 0.8),
            ...
            this.distance.boost &&
              this.speed.current > 0 &&
              this.addLine(this.boostFx),
            this.moveLines(this.driftFx, 1.2),
            (this.driftFx = this.driftFx.filter((A) => A.time < 0.5)),
            this.drift !== this.angle &&
              this.speed.current > this.speed.max / 3 &&
              this.addLine(this.driftFx));
        }
        moveLines(A, t) {
          A.length <= 0 ||
            A.forEach((A) => {
        ...
        draw() {
          if (hA.sys.isState(dA.Menu)) this.drawMenu();
          else if (
            (this.boostFx.length > 0 &&
              X.sys.drawLineFx(this.boostFx, "accent"),
      ...
      const P = {
        Endless: {
          ...
          saveScore() {
            if (hA.sys.game.cheat.used) return;
            const A = this.getScore();
            A > hA.sys.highScore.endless &&
              ((hA.sys.highScore.endless = A), hA.sys.triggerHighScore());
          },
          buildStartScene() {
            const A = hA.sys.session.x,
          ...
          checkPass(A) {
            "lure" === A.type &&
              A.hit &&
              A.y + 192 < J.entity.y &&
              (Z.sys.buildObject("foe", A.x, A.y + 32, "chase"),
              (A.sleep = !0));
          },
          buildNextLevel() {
            ...
            for (let s = -e; s <= e; s++) {
              ...
              0 === s
                ? J.entity.distance.air
                  ? (r = "allPassive")
                  : Z.sys.ready(this.distance.life)
                    ? (r = "endlessLives")
                    : Z.sys.ready(this.distance.friend)
                      ? (r = "endlessFriends")
                      : Z.sys.ready(this.distance.boost)
                        ? (r = "endlessBoosts")
                        : Z.sys.ready(this.distance.ramp)
                          ? (r = "endlessRamps")
                          : Z.sys.ready(this.distance.lure) &&
                            (r = "endlessLures")
                : ((e = i(-5, 5) * Z.sys.grid), (n = i(0, 8) * Z.sys.grid));
              const a = A + s * Z.sys.gap + e,
                o = t + n;
              (Z.sys.buildCluster(r, a, o), this.buildEndlessRandomSnags(a, o));
            }
          },
          buildEndlessRandomSnags(A, t) {
            ...
            for (let e = 0; e < a; e++) {
              ...
              if (Math.random() < 0.6) {
                c =
                  "string" == typeof (o = r(Object.keys(R.sys.spawnSingle)))
                    ? o
                    : "";
              }
        ...
        TimeTrial: {
          ...
          saveScore() {
            if (hA.sys.game.cheat.used) return;
            const A = this.getScore();
            A < hA.sys.highScore.timetrial &&
              hA.sys.game.finish &&
              ((hA.sys.highScore.timetrial = A), hA.sys.triggerHighScore());
          },
          buildStartScene() {
            this.buildNextLevel();
          },
        ...
        ZigZag: {
          ...
          saveScore() {
            if (hA.sys.game.cheat.used) return;
            const A = this.getScore();
            A > hA.sys.highScore.zigzag &&
              ((hA.sys.highScore.zigzag = A), hA.sys.triggerHighScore());
          },
          buildStartScene() {
            const A = hA.sys.session.x,
          ...
          checkPass(A) {
            ...
            "gate" !== A.type ||
              ...
              A.hit ||
              (hA.sys.game.friend
                ? (this.updateGate(A.gateId), W.removeFriend())
                : W.gameLose());
          },
          passGate(A) {
          ...
          createGateClusters(A, t, e) {
            const s = t + 0.5 * this.pixels.add;
            let n;
            Z.sys.buildCluster("zigzagGateScenes", A, s);
            const a = Z.sys.ready(this.distance.life);
            (Z.sys.ready(this.distance.friend) && !hA.sys.game.friend
              ? (n = "friend")
              : a
                ? (n = "life")
                : Math.random() < 0.1
        ...
        Collector: {
          ...
          saveScore() {
            if (hA.sys.game.cheat.used) return;
            const A = this.getScore();
            A > hA.sys.highScore.collector &&
              ((hA.sys.highScore.collector = A), hA.sys.triggerHighScore());
          },
          buildStartScene() {
            const A = hA.sys.session.x,
          ...
          update() {
            !this.flagScore &&
              hA.sys.game.coins > hA.sys.highScore.collector &&
          ...
          buildNextLevel() {
            ...
            Z.sys.ready(this.distance.friend) && !hA.sys.game.friend
              ? Z.sys.buildCluster("collectorFriends", A, t)
              : e
                ? Z.sys.buildCluster("collectorScenes", A, t)
                : (Z.sys.buildCluster("collectorCoinsOnly", A, t),
                  Z.sys.buildCluster(
                    "allNormal",
                    A,
                    t + 256,
        ...
        setup() {
          (new R(),
            ...
            this.list.forEach((A) => {
              (A.setup(), A.reset(), o(A.library, R.sys.library));
            }));
        },
        reset() {
          this.active.reset();
        ...
        cycleMode(A) {
          ...
          ((this.active = t[n]), this.reset(), Z.sys.refreshMenuModeCluster());
        },
        isMode(A) {
          return this.active === A;
        },
      ...
      //@inject gamemodeRegistered
      class X {
        constructor() {
          if (X.sys) return X.sys;
          ((X.sys = this),
        ...
        createPlayerSprite(A) {
          ...
          if (
            (this.applyLayers(e.ctx, q.sys.playerImg, [0, 64, 128], t, 64, 16),
            "konami" === A)
          )
        ...
        createPlayerBody(A, t) {
          const e = this.createCanvas(A, 96),
            s = this.colorize(
              ...
              0,
              256,
              this.bodyColors[hA.sys.settings.playerBodyColor],
              A,
              t,
            );
          e.ctx.drawImage(s.canvas, 0, 0, A, t, 0, 16, A, t);
          const n =
              u.sys.sheet.player.outfit[hA.sys.settings.playerOutfitStyle],
            i = this.colorize(
              q.sys.playerImg,
              0,
              n,
              this.outfitColors[hA.sys.settings.playerOutfitColor],
              A,
              t,
            );
          ...
          const r = 32,
            ...
            c = this.colorize(
              ...
              o,
              512,
              this.hairColors[hA.sys.settings.playerHairColor],
              r,
              a,
            ),
          ...
          return (
            g.ctx.drawImage(q.sys.playerImg, l, 576, r, a, 0, 0, r, a),
        ...
        defineCanvas() {
          ...
          ((hA.sys.session.w = parseInt(A.getPropertyValue("width"), 10)),
            ...
            (hA.sys.session.x = Math.floor(0.5 * hA.sys.session.w)),
            (hA.sys.session.y = Math.floor(0.4 * hA.sys.session.h)),
        ...
        drawPlayerSprite(A, t = 0, e = 0, s = 1) {
          const n = hA.sys.settings.reducedMotion
              ? 0
              : hA.sys.game.time.elapsed,
        ...
        drawLayer(A, t, e = 0, s = 0, n = 0, i = "looping", r) {
          ...
          const a = u.sys.sheet[A],
            o = a.poseData[t],
            c =
              hA.sys.settings.reducedMotion && "oneshot" !== i
                ? o.length - 1
                : Math.floor(n * a.fps) % o.length;
          if (
            (this.draw(q.sys.objectsImg, a, e, s, o[c]),
            ("oneshot" === i || "ending" === i) &&
              Math.ceil(n * a.fps) > o.length - 1)
          )
            switch (i) {
              case "oneshot":
                r.anim = "paused";
      ...
      class q {
        constructor() {
          if (q.sys) return q.sys;
          ((q.sys = this), (this.Horizon = b), (this.Surf = C));
        }
        setup() {
      ...
      const _ = l(),
        $ = {
          ...
          buildTopUI() {
            ...
            ((this.player = m.createIconButton(
              gA.sys.topLeft,
              "editPlayer",
              1,
              A,
            ...
            ((gA.sys.buttonShare = m.createIconButton(
              gA.sys.topRight,
              "share",
              1,
              e,
            ...
            ((gA.sys.buttonSettings = m.createIconButton(
              gA.sys.topRight,
              "settings",
              1,
              s,
          ...
          refreshModeUI() {
            ((this.modeTitle.textContent = _.getString(
              P.active.stringLookup.title,
            )),
              (this.modeText.textContent = _.getString(
                P.active.stringLookup.howto,
              )),
              gA.sys.refreshStatsUI());
          },
          buildActionUI() {
            const A = _.getString("menuMainButton"),
              t = gA.sys.buildActionButtonUI(
                gA.sys.actionUI,
                "playCircle",
                3,
                A,
        ...
        tA = {
          ...
          buildTopUI() {
            ...
            m.clickEvent(
              t,
              function () {
                (tA.revertPlayer(), gA.sys.changeMenu(gA.sys.Main));
              },
              !0,
            );
          },
            ...
            (m.clickEvent(
              ...
              function () {
                ...
                (gA.sys.changeMenu(gA.sys.Main),
                  ...
                  M(
                    "recordBodyColor",
                    g((A = h.data.settings).playerBodyColor, 8),
                  ),
          ...
          previousPreview() {
            switch (this.activeSubmenu) {
              case this.editOutfit:
                hA.sys.settings.playerOutfitStyle =
                  (u.sys.sheet.player.outfit.length +
                    hA.sys.settings.playerOutfitStyle -
                    1) %
                  u.sys.sheet.player.outfit.length;
                break;
              case this.editHair:
                hA.sys.settings.playerHairStyle =
                  (u.sys.sheet.player.hair +
                    hA.sys.settings.playerHairStyle -
                    1) %
                  u.sys.sheet.player.hair;
                break;
              case this.editExtras:
                hA.sys.settings.playerExtraStyle =
                  (u.sys.sheet.player.extra +
                    hA.sys.settings.playerExtraStyle -
                    1) %
                  u.sys.sheet.player.extra;
            }
            (hA.sys.saveSessionSettings(), X.sys.createPlayerSprite());
          },
          nextPreview() {
            switch (this.activeSubmenu) {
              case this.editOutfit:
          ...
          previousEdit() {
            const A =
              this.activeColor.previousElementSibling ||
              this.colorPicker.lastElementChild;
            this.changeColor(A);
          },
          nextEdit() {
            const A =
              this.activeColor.nextElementSibling ||
              this.colorPicker.firstElementChild;
            this.changeColor(A);
          },
          changeColor(A) {
            ...
            switch (this.activeSubmenu) {
              case this.editBody:
                ...
                break;
              case this.editOutfit:
                hA.sys.settings.playerOutfitColor =
                  X.sys.outfitColors.indexOf(t);
                break;
              case this.editHair:
          ...
          revertPlayer() {
            ((hA.sys.settings.playerBodyColor = this.revert.playerBodyColor),
              ...
              (hA.sys.settings.playerOutfitStyle =
                this.revert.playerOutfitStyle),
              (hA.sys.settings.playerOutfitColor =
                this.revert.playerOutfitColor),
        ...
        sA = {
          ...
          buildTopUI() {
            ...
            m.clickEvent(
              t,
              function () {
                (sA.revertTheme(), gA.sys.changeMenu(gA.sys.Main));
              },
              !0,
            );
          },
          ...
          refreshHeaderUI() {
            this.title.textContent = eA.getString(
              q.sys.activeTheme.stringLookup.title,
            );
          },
          buildThemeUI() {
            const A = m.create("div", gA.sys.secondaryUI, "alt-select"),
        ...
        iA = {
          buildMenu() {
            (this.buildTopUI(), m.show(gA.sys.statsUI));
          },
          buildTopUI() {
        ...
        aA = {
          ...
          buildHeaderUI() {
            m.create("h1", gA.sys.headerUI, "ui-title").textContent =
              rA.getString("menuPauseTitle");
          },
          buildActionUI() {
        ...
        cA = {
          ...
          animateScoreMeter() {
            ...
            ((this.scoreText.textContent = A),
              ...
              hA.sys.game.highScore &&
                (m.show(cA.scoreIcon), m.classAdd(cA.statsScore, "highscore")));
          },
          buildShareRow(A) {
      ...
      class gA {
        ...
        setup() {
          ((this.active = gA.sys.Main),
            ...
            this.list
              ...
              .forEach((A) => {
                (A.loadClusters(), o(A.library, R.sys.library));
              }));
        }
        isMenu(A) {
          return this.active === A;
        ...
        buildContainers() {
          ((this.ui = m.create("div", document.body, "game-ui")),
            ...
            (this.topLeft = m.create(
              "nav",
              this.ui,
              "top-left",
              "top-container",
            )),
            (this.topRight = m.create(
              "nav",
              this.ui,
              "top-right",
              "top-container",
        ...
        buildIcons() {
          (m.clear(this.statsLives), m.clear(this.statsBoosts));
        ...
        checkHighScore() {
          hA.sys.game.highScore || hA.sys.isState(dA.Menu)
            ? (m.show(this.scoreIcon), m.classAdd(this.statsUI, "highscore"))
            : (m.hide(this.scoreIcon), m.classDel(this.statsUI, "highscore"));
        }
        updateScore() {
          let A = 100;
          (hA.sys.isState(dA.Menu)
            ? (this.scoreText.textContent = P.active.getHighScoreFormatted())
            : ((this.scoreText.textContent = P.active.getScoreFormatted()),
        ...
        updateIcons() {
          ...
          if (hA.sys.game.cheat.lives || hA.sys.game.cheat.safety)
            A = [
              "empty",
              hA.sys.game.cheat.safety ? "shield" : "life-full",
              "infinite",
            ];
          else
            for (let t = 0; t < hA.sys.game.lives.max; t++)
              t < hA.sys.game.shields.current
                ? (A[t] = "shield")
                : t < hA.sys.game.lives.current
                  ? (A[t] = "life-full")
                  : (A[t] = "life-empty");
          let t = [];
          if (hA.sys.game.cheat.boosts) t = ["boost-full", "infinite", "empty"];
          else
            for (let A = 0; A < hA.sys.game.boosts.max; A++) {
              const e =
                A < hA.sys.game.boosts.current ? "boost-full" : "boost-empty";
              t[A] = e;
            }
          const e = this.statsLives.querySelectorAll("span"),
            s = this.statsBoosts.querySelectorAll("span");
          for (let t = 0; t < e.length; t++)
            (e[t].removeAttribute("class"), m.classAdd(e[t], A[t]));
          for (let A = 0; A < s.length; A++)
            (s[A].removeAttribute("class"), m.classAdd(s[A], t[A]));
        }
      }
      var dA;
      ((gA.sys = null),
      ...
      class hA {
        constructor() {
          if (((this.game = void 0), hA.sys)) return hA.sys;
          ((hA.sys = this),
            (this.settings = {}),
            (this.highScore = {}),
            (this.session = {
        ...
        update(A) {
          ((this.game.time.loop = A / 1e3),
            ...
            (this.game.time.scale =
              60 * this.game.time.loop * this.settings.gameSpeed));
        }
        updateDistances(A) {
        ...
        addItem(A, t = 1) {
          ((A.current = Math.min(A.current + t, A.max)), gA.sys.updateIcons());
        }
        delItem(A, t = 1) {
          ((A.current = Math.max(A.current - t, 0)), gA.sys.updateIcons());
        }
        getState() {
      ...
      class bA {
        ...
        gameLoop(A) {
          if ((j.sys.update(), !hA.sys.isState(dA.Pause)))
            switch ((hA.sys.update(A), hA.sys.getState())) {
              case dA.Play:
                this.updatePlay();
                break;
              case dA.Menu:
        ...
        changeState(A) {
          ...
          (gA.sys.refreshStatsUI(), q.sys.checkForcedColors());
        }
        triggerMenu() {
          (P.active.saveScore(),
            hA.sys.reset(),
        ...
        reflowCanvas() {
          ...
          (Z.sys.calcClusterSlots(),
            ...
            X.sys.updateBackground(e, s, { x: 0, y: 0 }),
            this.render());
        }
        render() {
          (X.sys.clearCanvas(), X.sys.drawBackground());
          const A = Z.sys.all.filter(function (A) {
            return (
              A.x > -A.w &&
              A.x < hA.sys.session.w + A.w &&
              A.y < hA.sys.session.h + A.h
            );
          });
          //@inject beforeRender
          (A.forEach((A) => {
            ...
            hA.sys.settings.hitbox &&
              A.forEach((A) => {
                X.sys.drawHitbox(A.type, A.hitbox);
              }),
            hA.sys.isState(dA.Menu) ||
              P.isMode(P.Endless) ||
              X.sys.drawBoundaries());
          //@inject afterRender
        }
      }
      bA.sys = null;
        ...
        !(function () {
          ...
          ((A = this),
            ...
            (i = function* () {
              (yield new Promise((A) => {
                (window.addEventListener("message", (t) => {
                  t.origin.startsWith(s) &&
                    "init" === t.data.type &&
                    ((n = { data_: t.data.data }), A());
                }),
                  window.parent.postMessage({ type: "requestData" }, s));
              }),
                new bA(),
                yield bA.sys.setup());
              ...
              const t = () => {
                ...
                (bA.sys.gameLoop(e), (A = window.performance.now()));
              };
              (requestAnimationFrame(t),
                (function (A, t) {
                  let e;
