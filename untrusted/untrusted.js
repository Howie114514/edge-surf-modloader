 ...
 * https://github.com/Howie114514/EdgeSurfModLoader
 */
(() => {
  "use strict";
  ...
  var A = {
        ...
        A.exports = function (A) {
          ...
          return t.toString = function () {
            return this.map(function (t) {
              var e = "",
                s = void 0 !== t[5];
              return t[4] && (e += "@supports (".concat(t[4], ") {")), t[2] && (e += "@media ".concat(t[2], " {")), s && (e += "@layer".concat(t[5].length > 0 ? " ".concat(t[5]) : "", " {")), e += A(t), s && (e += "}"), t[2] && (e += "}"), t[4] && (e += "}"), e;
            }).join("");
            ...
            for (var c = 0; c < A.length; c++) {
              var l = [].concat(A[c]);
              s && r[l[0]] || (void 0 !== i && (void 0 === l[5] || (l[1] = "@layer".concat(l[5].length > 0 ? " ".concat(l[5]) : "", " {").concat(l[1], "}")), l[5] = i), e && (l[2] ? (l[1] = "@media ".concat(l[2], " {").concat(l[1], "}"), l[2] = e) : l[2] = e), n && (l[4] ? (l[1] = "@supports (".concat(l[4], ") {").concat(l[1], "}"), l[4] = n) : l[4] = "".concat(n)), t.push(l));
            }
          }, t;
        };
      },
      ...
      379: A => {
        var t = [];
        function e(A) {
          for (var e = -1, s = 0; s < t.length; s++) if (t[s].identifier === A) {
            e = s;
            break;
          }
          return e;
      ...
      37: A => {
        ...
        function s(A, t, s, n) {
          var i;
          if (s) i = "";else {
            i = "", n.supports && (i += "@supports (".concat(n.supports, ") {")), n.media && (i += "@media ".concat(n.media, " {"));
            var r = void 0 !== n.layer;
            r && (i += "@layer".concat(n.layer.length > 0 ? " ".concat(n.layer) : "", " {")), i += n.css, r && (i += "}"), n.media && (i += "}"), n.supports && (i += "}");
          }
          if (A.styleSheet) A.styleSheet.cssText = e(t, i);else {
  ...
  e.n = A => {
    ...
    for (var s in t) e.o(t, s) && !e.o(A, s) && Object.defineProperty(A, s, {
      enumerable: !0,
      get: t[s]
    });
    ...
    const h = {
        ...
        once() {
          return new Promise(A => {
            location.origin == t ? window.addEventListener("message", t => {
              console.log("Received Message in " + location.origin), console.dir(t), null != t.data.gameStats && ("" == t.data.gameStats ? (this.data = this.createData(), this.updateHighScores()) : (this.data = JSON.parse(t.data.gameStats), this.updateData()), A(!0));
            }) : A(!1);
          });
        },
        updateHighScores() {
          ...
          this.data.highScore.endless = Math.max(this.data.highScore.endless, A[0]), this.data.highScore.zigzag = Math.max(this.data.highScore.zigzag, A[2]), -1 != A[1] && (this.data.highScore.timetrial = Math.min(this.data.highScore.timetrial, A[1]));
        },
        updateData() {
          const A = this.createData();
          for (const t in A) if (t in this.data) {
        ...
        getData() {
          location.origin == t ? (window.parent.postMessage({
            type: "getGameData"
          }, s), this.data || (this.data = this.createData())) : this.data = this.createData();
        },
        setData() {
          location.origin == t && window.parent.postMessage({
            type: "saveGameData",
        ...
        resetData() {
          this.data = this.createData(), hA.sys.loadSessionSettings(), this.setData(), hA.sys.reset();
        },
        createData: () => ({
          settings: {
            playerBodyColor: 5,
    ...
    class B {
      ...
      reset() {
        ...
        this.w = A.w, this.h = A.h, this.fx = A.fx, this.hit = !1, this.hitbox = {
    ...
    class p extends B {
      ...
      draw() {
        this.pickup ? X.sys.drawPickup(this) : (void 0 !== this.fx && "hidden" !== this.anim && X.sys.drawFx(this.time, this.x, this.y + this.fx), X.sys.drawLayer(this.type, this.pose, this.x, this.y, this.time, this.anim, this), void 0 !== this.decor && X.sys.drawLayer("wallDecor", this.decor, this.x, this.y - 24));
      }
    }
    class w extends p {
      constructor(A, t, e, s) {
      ...
      reset() {
        super.reset(), this.objectsHit = [], this.radian = 0, this.speed = {
          current: 6,
          raw: 6,
          max: 13,
          accel: 0.025
          ...
          crash: 0,
          direction: 0
        }, this.style = i(0, 3), this.changeState("crash"), this.resume();
      }
      update() {
      ...
      isCrashed() {
        return !(this.timer.crash <= 0 || (this.timer.crash -= hA.sys.game.time.loop, this.timer.crash <= 0 && (this.resume(), 1)));
      }
      changeState(A) {
        ...
        this.pose = A, this.radian = t * Math.PI / 180, "crash" === A && (this.timer.crash += 1.5, this.speed.raw = 0);
      }
      updateDirection() {
        if (this.timer.direction -= hA.sys.game.time.loop, this.timer.direction <= 0) {
      ...
      updateSpeed() {
        ...
        this.speed.raw = A.raw <= A.max ? A.raw += t : A.raw -= t, this.speed.current = A.raw * hA.sys.game.time.scale;
      }
      updatePosition() {
    ...
    class y extends p {
      ...
      reset() {
        super.reset(), this.objectsHit = [], this.radian = 0, this.dist = 0, this.speed = {
          current: 3,
          raw: 3,
          max: 9,
          accel: 0.05
      ...
      updateEnding() {
        ...
        if (Math.hypot(A.x, A.y) < 8) this.shift(A.x, A.y), this.changeState("end"), hA.sys.game.caught = !0;else {
      ...
      changeState(A) {
        if (this.state !== A) {
          switch (this.state = A, this.timer = {
            crash: 0,
            direction: 0
          }, A) {
            case "chase":
      ...
      updateDirection() {
        if (this.dist = Math.hypot(hA.sys.session.x - this.x, hA.sys.session.y - this.y), this.timer.direction -= hA.sys.game.time.loop, this.timer.direction <= 0) {
      ...
      updateSpeed() {
        ...
        A.raw < A.max && !e ? this.speed.raw += t : e ? this.speed.raw -= t : this.speed.raw = A.max, this.speed.current = A.raw * hA.sys.game.time.scale;
      }
      updatePosition() {
    ...
    const m = {
        ...
        clickEffect(A, t) {
          A.stopPropagation(), this.classAdd(t, "clickfx"), setTimeout(function () {
        ...
        create(A, t, e, s, n) {
          ...
          return t && t.insertAdjacentElement("beforeend", i), e && (i.id = e), s && this.classAdd(i, s), n && (i.textContent = n), i;
        },
        createButton(A, t = "Button", e) {
          const s = this.create("button", A);
          return this.classAdd(s, "btn"), s.setAttribute("aria-label", t), s.setAttribute("name", t), s.setAttribute("title", t), s.setAttribute("type", "button"), s.addEventListener("click", function (A) {
            m.clickEffect(A, s), m.focusGroup(s);
          }), void 0 !== e && this.setRowAttribute(s, e), s;
        },
        setRowAttribute(A, t) {
        ...
        createIconSVG(A, t) {
          ...
          s.setAttribute("xmlns", e), s.setAttribute("viewBox", "0 0 24 24"), s.setAttribute("focusable", "false"), this.classAdd(s, "icon");
          const n = document.createElementNS(e, "path");
          return n.setAttribute("d", this.icon[t]), this.classAdd(n, t), s.insertAdjacentElement("beforeend", n), A.insertAdjacentElement("beforeend", s), s;
        },
        classAdd(...A) {
          const t = A.shift();
          A.forEach(A => {
      ...
      f = {
        setup() {
          window.addEventListener("keydown", A => f.onKeydown(A)), window.addEventListener("keyup", A => f.onKeyup(A));
        },
        reset() {
          this.pressed = {};
        },
      ...
      x = {
        setup() {
          window.addEventListener("click", A => x.onClick(A)), window.addEventListener("mousemove", A => x.onMouseMove(A)), window.addEventListener("contextmenu", A => x.onContextMenu(A));
        },
        reset() {
          this.last = void 0;
        },
        ...
        onContextMenu(A) {
          A.preventDefault(), j.sys.changeInput(j.sys.Mouse), j.sys.routeInput(z.Boost);
        }
      },
      v = {
        setup() {
          window.addEventListener("touchstart", A => v.onTouchStart(A)), window.addEventListener("touchmove", A => v.onTouchMove(A)), window.addEventListener("touchend", A => v.onTouchEnd(A));
        },
        reset() {
          this.last = void 0, this.swipe = 0, this.touch = {
            down: {
              x: 0,
              y: 0
            },
        ...
        onTouchStart(A) {
          if (!this.ignored(A) && (j.sys.changeInput(j.sys.Touch), A.targetTouches)) {
            const t = A.targetTouches[0];
            this.last = void 0, this.swipe = Date.now(), this.touch = {
              down: {
                x: t.clientX,
                y: t.clientY
              },
        ...
        onTouchEnd(A) {
          ...
          this.last = void 0;
          let n = !1;
          Math.abs(t) < 10 && Math.abs(e) < 10 ? (n = !0, s = j.sys.checkAngle(hA.sys.session, this.touch.down)) : Date.now() - this.swipe <= 400 && (s = j.sys.checkAngle(this.touch.down, this.touch.move)), s && !hA.sys.isState(dA.Menu) && (j.sys.routeInput(s, n), j.sys.checkCheatCode(s));
        },
        ignored: A => !!A.target.closest("button") || (A.cancelable && A.preventDefault(), !1)
      },
      E = {
        setup() {
          window.addEventListener("gamepadconnected", A => E.onConnect(A)), window.addEventListener("gamepaddisconnected", A => E.onDisconnect(A)), this.list = [], this.button = ["a", "b", "x", "y", "lb", "rb", "lt", "rt", "select", "start", "lstick", "rstick", "up", "down", "left", "right", "home", "touchpad"], this.event = {
            default: {
              ms: 0,
              weak: 0.4,
              strong: 0.4
        ...
        onDisconnect(A) {
          ...
          t > -1 && E.list.splice(t, 1), this.linked = {
            index: void 0,
            pad: void 0,
            pressed: {}
          }, this.reset(), j.sys.isInput(j.sys.Gamepad) && j.sys.changeInput(j.sys.Keys);
        },
        setGamepad(A, t) {
          this.linked = {
            index: A,
        ...
        update() {
          if (!(this.list.length <= 0)) if (void 0 === this.linked.index) this.list.forEach(A => {
        ...
        updateVibrations() {
          this.applyVibration(), this.timer -= 1e3 * hA.sys.game.time.loop, this.timer <= 0 && this.vibrate();
        },
        checkJoysticks(A) {
          const t = 0.5,
          ...
          let r;
          return (e || s || i || n) && (r = !n || e || s ? !s || i || n ? !e || i || n ? s && n ? z.DownLeft : e && n ? z.DownRight : z.Up : z.Right : z.Left : z.Down), r;
        },
        routeJoystick(A) {
          this.last !== A && (this.last = A, A && (j.sys.routeInput(A, !0), j.sys.changeInput(j.sys.Gamepad)));
        },
        checkButtons(A) {
          let t;
          for (let s = 0; s < A.buttons.length; s++) if ("object" == typeof (e = A.buttons[s]) ? e.pressed : 1 === e) {
        ...
        routeButton(A) {
          A && (j.sys.routeInput(A), j.sys.checkCheatCode(A), j.sys.changeInput(j.sys.Gamepad));
        }
      },
      D = "recordActions";
    var Q, k, I;
    ...
    !function (A) {
      ...
      A[A.Surf = 0] = "Surf", A[A.Classic = 1] = "Classic", A[A.Ski = 2] = "Ski", A[A.Bike = 3] = "Bike", A[A.Seasonal = 4] = "Seasonal", A[A.Special_Event = 5] = "Special_Event", A[A.New_Theme = 6] = "New_Theme";
    }(k || (k = {})), function (A) {
      A[A.Classic = 0] = "Classic", A[A.Buoy = 1] = "Buoy", A[A.Speed = 2] = "Speed", A[A.Collector = 3] = "Collector";
    }(I || (I = {}));
    const H = l(),
      F = {
        setup() {
          this.flyout = m.create("div", document.body, "flyout-share", "modal"), m.classAdd(this.flyout, "flyout"), this.button = void 0, this.close = void 0;
          const A = m.create("div", this.flyout, void 0, "modal-row"),
            t = H.getString("gameShare");
          m.create("span", A, void 0, "flyout-title", t), T.sys.buildCloseButton(F, A), m.create("div", this.flyout, void 0, "flyout-rule");
          ...
          a.setAttribute("data-menu", "2"), m.classAdd(a, "btn-full"), this.shareString = m.create("span", a, void 0, void 0, n), d() ? m.clickEvent(a, function () {
            M(D, Q.SHARE);
          }, !0) : m.clickEvent(a, function () {
            var A;
            M(D, Q.SHARE), A = H.getString("shareLink"), navigator.clipboard.writeText(A), F.updateShare(r), setTimeout(function () {
              F.updateShare(n);
            }, 2e3);
          }, !0), m.create("div", this.flyout, void 0, "flyout-rule");
          ...
          if (m.create("span", o, void 0, "flyout-text", l), !d()) {
            ...
            e.setAttribute("data-menu", "3"), m.clickEvent(e, function () {
      ...
      U = {
        setup() {
          this.flyout = m.create("div", document.body, "dialog-credits", "modal"), m.classAdd(this.flyout, "dialog"), this.button = void 0;
          const A = m.create("div", this.flyout, void 0, "modal-row"),
            t = S.getString("settingsCredits");
          m.create("span", A, void 0, "flyout-title", t), T.sys.buildCloseButton(U, A), this.addNames("settingsCreditsDesign", "Parker Young, William Devereux, Scott Porterfield, Michael Diaz"), this.addNames("settingsCreditsEngineering", "Parker Young, Connor Smith, Steven Lengieza, Ryan Ata, Jose Luis Teran, Adina Shanholtz, Ray Rivers, 陈嘉钰, 傅远, 胡雨阳, 郑俊豪"), this.addNames("settingsSpecialThanks", "Jonathan Merrin, Patrick Evan Little, Charles Duval, Addison Kaufmann, Rachel Weil, Joseph Oak, Amanda Velasco Gallardo, Ramya Challa, Chris Pirih");
          const e = m.create("div", this.flyout, void 0, "modal-row"),
            s = S.getString("actionClose"),
            n = m.createTextButton(e, s, "btn-half");
          n.setAttribute("data-menu", "2"), m.clickEvent(n, function () {
            T.sys.toggleFlyout(U);
          }, !0), m.hide(this.flyout);
        },
        addNames(A, t) {
          const e = m.create("div", this.flyout, void 0, "modal-col"),
            s = S.getString(A);
          m.create("span", e, void 0, "flyout-header", s), m.create("span", e, void 0, "flyout-text", t);
        }
      },
      N = l(),
      L = {
        setup() {
          this.flyout = m.create("div", document.body, "dialog-reset", "modal"), m.classAdd(this.flyout, "dialog"), this.button = void 0;
          const A = m.create("div", this.flyout, void 0, "modal-row"),
            t = N.getString("settingsResetAllStatsDialogTitle");
          m.create("span", A, void 0, "flyout-title", t), T.sys.buildCloseButton(L, A);
          const e = m.create("div", this.flyout, void 0, "modal-col"),
          ...
          r.setAttribute("data-menu", "2"), m.clickEvent(r, function () {
            h.resetData(), q.sys.updateTheme(), O.updateAllToggles(), bA.sys.changeState(dA.Menu);
          }, !0);
          const a = N.getString("actionCancel"),
            o = m.createTextButton(n, a, "btn-half");
          o.setAttribute("data-menu", "2"), m.clickEvent(o, function () {
      ...
      O = {
        setup() {
          this.flyout = m.create("div", document.body, "flyout-settings", "modal"), m.classAdd(this.flyout, "flyout"), this.button = void 0;
          const A = m.create("div", this.flyout, void 0, "modal-row"),
            t = Y.getString("gameSettings");
          m.create("span", A, void 0, "flyout-title", t), T.sys.buildCloseButton(O, A), m.create("div", this.flyout, void 0, "flyout-rule");
          ...
          this.buildToggle(n, "toggle-motion", this.flyout, 4), m.create("div", this.flyout, void 0, "flyout-rule");
          const i = m.create("div", this.flyout, void 0, "modal-row"),
            r = Y.getString("settingsResetAllStats"),
            a = m.createTextButton(i, r, "btn-small");
          a.setAttribute("data-menu", "5"), m.clickEvent(a, function () {
            T.sys.toggleFlyout(L);
          });
          const o = Y.getString("settingsCredits"),
            c = m.createTextButton(i, o, "btn-small");
          c.setAttribute("data-menu", "5"), m.clickEvent(c, function () {
            T.sys.toggleFlyout(U);
          }), m.hide(this.flyout);
        },
        buildToggle(A, t, e, s) {
          const n = m.create("div", e, void 0, "modal-row");
          m.create("span", n, void 0, "input-title", A), m.create("span", n, void 0, "input-label");
          const i = m.createButton(n, A);
          i.setAttribute("data-menu", s.toString()), m.classDel(i, "btn"), m.classAdd(i, "toggle"), i.id = t;
          const r = m.create("span", i, void 0, "toggle-display");
          return this.updateToggle(i), m.clickEvent(i, function () {
        ...
        updateToggle(A) {
          ...
          A.previousElementSibling.innerText = Y.getString(e), bA.sys.render();
        },
        updateAllToggles() {
          this.updateToggle(document.querySelector("#toggle-hitbox")), this.updateToggle(document.querySelector("#toggle-speed")), this.updateToggle(document.querySelector("#toggle-motion"));
        }
      },
      G = l();
    class T {
      constructor() {
        ...
        T.sys = this, this.Share = F, this.Settings = O, this.Credits = U, this.Reset = L;
      }
      setup() {
        this.active = void 0, this.list = [this.Share, this.Settings, this.Credits, this.Reset], this.list.forEach(A => {
          A.setup();
        }), this.overlay = m.create("div", gA.sys.ui, "ui-overlay"), m.hide(this.overlay);
      }
      overlayScreen() {
        this.isFlyoutOpen() ? m.show(this.overlay) : m.hide(this.overlay);
      }
      toggleFlyout(A = O) {
        this.isOpen(A) ? this.closeFlyout(A) : (this.closeAllFlyouts(), hA.sys.isState(dA.Play) && bA.sys.changeState(dA.Pause), this.openFlyout(A));
      }
      isOpen(A) {
      ...
      openFlyout(A) {
        this.setupHideOnClick(A.flyout), m.show(A.flyout), this.overlayScreen(), m.focusButton(A.close), this.active = A, void 0 !== A.button && A.button.setAttribute("aria-expanded", "true");
      }
      closeFlyout(A) {
        m.hide(A.flyout), this.overlayScreen(), this.active = void 0, void 0 !== A.button && (m.focusButton(A.button), A.button.setAttribute("aria-expanded", "false"));
      }
      setupHideOnClick(A) {
        const t = t => {
            A.contains(t.target) || null !== A.getAttribute("hidden") || (T.sys.closeAllFlyouts(), e());
          },
          e = () => {
      ...
      focusFlyoutElement(A) {
        ...
        A.shiftKey || t.indexOf(e) + 1 !== t.length ? A.shiftKey && 0 === t.indexOf(e) && (m.focusButton(t[t.length - 1]), A.preventDefault()) : (m.focusButton(t[0]), A.preventDefault());
      }
      buildCloseButton(A, t) {
        const e = G.getString("actionClose");
        A.close = m.createIconButton(t, "close", void 0, e), m.classAdd(A.close, "dismiss"), A.close.setAttribute("data-menu", "1"), m.clickEvent(A.close, function () {
    ...
    class Z {
      constructor() {
        ...
        Z.sys = this, this.grid = 64, this.slots = 3, this.gap = 1024, this.all = [], this.top = [], this.btm = [], this.npc = [], this.foe = [];
      }
      reset() {
        this.storeObjects(), this.all = [], this.prevClusters = [], this.top = [], this.btm = [], this.npc = [], this.foe = [], this.lairBuilt = !1, this.endingFoe = void 0, this.merge();
      }
      start() {
        P.spawnStart();
      }
      ...
      refreshMenuThemeCluster() {
        ...
        const A = hA.sys.session.x,
          t = hA.sys.session.y;
        Z.sys.buildCluster(gA.sys.active.menuCluster, A, t, "menu1"), this.merge();
      }
      calcClusterSlots() {
      ...
      buildCluster(A, t, e, s) {
        ...
        const n = R.sys.library[A][s],
          i = [];
        this.prevClusters.unshift(s), this.prevClusters.length > 14 && this.prevClusters.pop();
        for (const A in n) if (n.hasOwnProperty(A)) {
          const s = n[A],
            o = s.length;
          for (let n = 0; n < o; n++) {
            const o = s[n];
      ...
      buildCheckpoint(A, t) {
        P.active.pixels.next += P.active.pixels.add, this.top = this.sleep(this.top, -64, hA.sys.session.h + 64), this.buildCluster("endlessCheckpoints", A, t);
      }
      buildLair() {
        this.lairBuilt = !0, P.active.pixels.next += 1280, this.top = this.sleep(this.top, -64, hA.sys.session.h + 64);
      ...
      buildObject(A, t, e, s) {
        ...
        t = Math.floor(t) + (n - Math.floor(n)), e = Math.floor(e) + (i - Math.floor(i));
        let a = this.wake(A, t, e, s);
        switch (a || (a = this.createObject(A, t, e, s)), a.type) {
          case "wall":
            !function (A, t) {
              !["f1", "f2", "f3"].includes(t) && Math.random() < 0.5 && (A.decor = r(["a", "b", "c", "d", "e", "f", "g", "h"]));
            }(a, s);
            break;
          case "ambient":
            a.anim = "hidden";
      ...
      merge() {
        ...
        J.entity.distance.air ? (A.sort((A, e) => t(A, e)), A.push(J.entity)) : (A.push(J.entity), A.sort((A, e) => t(A, e))), this.all = this.btm.concat(A);
      }
      storeObjects() {
        if (this.sleeping) this.sleeping = this.sleeping.concat(this.top).concat(this.btm).concat(this.npc).concat(this.foe);else {
          this.populate = {
            wall: 40,
            snag: 40,
            snagsml: 20,
          ...
          for (const A in this.populate) if (this.populate.hasOwnProperty(A)) {
      ...
      putToSleep() {
        this.top = this.sleep(this.top), this.btm = this.sleep(this.btm), this.npc = this.sleep(this.npc, -64, hA.sys.session.h + 64), this.foe = this.sleep(this.foe, -256);
      }
      sleep(A, t = -64, e = 1e4) {
        const s = A.filter(A => !n(A));
        return this.sleeping = this.sleeping.concat(s), A.filter(A => n(A));
        function n(A) {
    ...
    const K = {
        update() {
          this.allObjects = this.filterVisible(Z.sys.top.concat(Z.sys.btm)), P.active.checkCollisions();
        },
        checkPlayerObjects() {
          const A = J.entity;
          for (let t = 0; t < this.allObjects.length; t++) {
            const e = this.allObjects[t];
            if (!this.collision(A, e) || e.hit || A.distance.air) this.playerPassed(e) && ("ambient" === e.type && "hidden" === e.anim ? (e.anim = "oneshot", e.time = 0) : P.active.checkPass(e));else switch (e.hit = !0, e.type) {
              case "wall":
              case "snag":
              case "snagsml":
              case "snagtall":
        ...
        checkPlayerFoes() {
          ...
          for (let s = 0; s < t; s++) {
            const t = Z.sys.foe[s];
            this.collision(t, A) && !t.hit && t.timer.crash <= 0 && (hA.sys.game.shields.current > 0 ? (t.crash(), W.removeShield()) : A.isFoe ? t.crash() : (t.ending(), Z.sys.endingFoe = t, W.gameLose()));
            for (let A = 0; A < e; A++) {
              const e = Z.sys.npc[A];
        ...
        checkPlayerNpcs() {
          ...
          for (let e = 0; e < t; e++) {
            const t = Z.sys.npc[e];
            this.collision(t, A) && t.timer.crash <= 0 && (A.distance.boost || A.isFoe ? t.crash() : hA.sys.game.shields.current > 0 ? (t.crash(), W.removeShield()) : W.playerCrash());
          }
        },
        checkFoeNpcObject() {
          for (let A = 0; A < this.allObjects.length; A++) {
        ...
        collideNpcsFoes(A, t) {
          if (!(A.y < 16) && this.collision(t, A) && !t.objectsHit.includes(A)) switch (t.objectsHit.push(A), A.type) {
            case "wall":
            case "snag":
            case "snagsml":
            case "snagtall":
      ...
      W = {
        gameCheckpoint() {
          this.playerBoost(!0), Z.sys.npc.forEach(A => {
            A.crash();
          }), Z.sys.foe.forEach(A => {
            A.crash();
          });
        ...
        gameFinishline() {
          hA.sys.game.finish = !0, J.entity.gameOver(), J.entity.finishline(), bA.sys.changeState(dA.Over);
        },
        gameLose() {
          hA.sys.game.lives.current = 0, hA.sys.game.boosts.current = 0, hA.sys.game.shields.current = 0, J.entity.gameOver(), J.entity.lose(), bA.sys.changeState(dA.Over);
        },
        playerAir(A) {
          J.entity.air(A), j.sys.feedback("air");
        },
        playerBoost(A = !1) {
          !A && (hA.sys.game.boosts.current <= 0 || J.entity.distance.boost) || (A || hA.sys.game.cheat.boosts || hA.sys.delItem(hA.sys.game.boosts, 1), J.entity.boost(), gA.sys.refreshStatsUI(), j.sys.feedback("boost"));
        },
        gamePassGate(A) {
          P.active.passGate(A.gateId);
          const t = Z.sys.buildObject("ambient", J.entity.x, J.entity.y);
          t.hit = !0, K.collectAnim(t), this.changeGatePose(A, "pass"), j.sys.feedback("small");
        },
        changeGatePose(A, t) {
        ...
        gameLair() {
          J.entity.changeToFoe(), this.removeFriend(), Z.sys.top.filter(A => "lure" === A.type).forEach(A => {
            Z.sys.buildObject("foe", A.x, A.y, V.Chase), A.sleep = !0;
          }), hA.sys.game.cheat.used = !0, gA.sys.sendNotification("cheat"), j.sys.feedback("big");
        },
        playerCrash() {
          if (J.entity.distance.immune) return;
          j.sys.feedback("crash");
          const A = hA.sys.game.cheat;
          if (hA.sys.game.friend) return this.removeFriend(), J.entity.distance.immune = 128, void gA.sys.refreshStatsUI();
          A.lives || A.safety || hA.sys.delItem(hA.sys.game.lives, 1), gA.sys.refreshStatsUI(), hA.sys.game.lives.current <= 0 ? this.gameLose() : J.entity.crash();
        },
        collectItem(A) {
          switch (A.type) {
            case "boost":
          ...
          gA.sys.refreshStatsUI(), K.collectAnim(A), j.sys.feedback("pickup");
        },
        addFriend() {
          J.entity.isFoe || (hA.sys.addItem(hA.sys.game.shields, 3), hA.sys.game.friend = !0, X.sys.createPlayerSprite());
        },
        removeFriend() {
          hA.sys.game.friend && !hA.sys.game.cheat.safety && (hA.sys.delItem(hA.sys.game.shields, 3), hA.sys.game.friend = !1, Z.sys.buildCrashedFriend(), X.sys.createPlayerSprite(), P.active.distance.friend.next = hA.sys.game.dist.unit + P.active.distance.friend.add);
        },
        removeShield() {
          j.sys.feedback("small"), hA.sys.game.cheat.safety || hA.sys.delItem(hA.sys.game.shields, 1);
        }
      };
    var z, V;
    !function (A) {
      A.Settings = "settings", A.Back = "back", A.Click = "click", A.Left = "left", A.Right = "right", A.Down = "down", A.Up = "up", A.DownLeft = "downleft", A.DownRight = "downright", A.Boost = "boost";
    }(z || (z = {}));
    class j {
      constructor() {
        if (j.sys) return j.sys;
        j.sys = this, this.doubleDelay = 300, this.Keys = f, this.Mouse = x, this.Touch = v, this.Gamepad = E;
      }
      setup() {
        this.active = d() ? this.Touch : this.Keys, this.list = [this.Keys, this.Mouse, this.Touch, this.Gamepad], this.list.forEach(A => {
          A.setup(), A.reset();
        }), this.defineCodes(), this.reset();
      }
      reset() {
        this.list.forEach(A => {
          A.reset();
        }), this.last = 0, this.possible = [];
      }
      update() {
      ...
      routeInput(A, t = !1) {
        ...
        T.sys.isFlyoutOpen() ? this.moveFocus(T.sys.active.flyout, A, "menu") : hA.sys.isState(dA.Play) ? (!t && this.isDouble(A) && (A = z.Boost), J.entity.routeAction(A, t)) : this.moveFocus(document, A, "row");
      }
      moveFocus(A, t, e) {
      ...
      spacebarEnterKeydown(A) {
        "button" !== document.activeElement.nodeName.toLowerCase() && (A.preventDefault(), m.clickActionButton());
      }
      resetGame() {
      ...
      inputSettings() {
        hA.sys.isState(dA.Play) && bA.sys.changeState(dA.Pause), void 0 !== gA.sys.buttonSettings && T.sys.toggleFlyout();
      }
      checkAngle(A, t) {
      ...
      checkCheatCode(A) {
        ...
        this.possible = this.possible.filter(e => A === t[e.idx][e.pos]), t.filter(t => A === t[0]).forEach(A => {
          this.possible.push({
            idx: t.indexOf(A),
            pos: 0
          });
      ...
      cheat(A) {
        ...
        if (hA.sys.isState(dA.Menu)) switch (t.used = !0, t[A] = !0, A) {
          case "lives":
            hA.sys.addItem(hA.sys.game.lives, 1);
            break;
          case "boosts":
        ...
        t.lives || t.boosts || t.safety || (t.used = !1), gA.sys.updateIcons();
      }
      changeInput(A) {
        this.isInput(A) || (this.active = A, this.active.reset(), hA.sys.saveSessionSettings());
      }
      isInput(A) {
    ...
    j.sys = null, function (A) {
      A.Left = "left", A.Right = "right", A.Down = "down", A.Up = "up", A.DownLeft = "downleft", A.DownRight = "downright", A.Crash = "crash", A.End = "end", A.Air1 = "air1", A.Air2 = "air2", A.Chase = "chase";
    }(V || (V = {}));
    class J extends p {
      constructor() {
        if (super("player", hA.sys.session.x, hA.sys.session.y, V.Down), J.entity) return J.entity;
        J.entity = this;
      }
      reset() {
        super.reset(), this.speed = {
          ...
          boost: void 0,
          immune: void 0
        }, this.angle = 0, this.drift = 0, this.radian = 0, this.direction = V.Up, this.shadow = 0, this.scale = 1, this.boostFx = [], this.driftFx = [], this.isFoe = !1, this.poses = [V.Left, V.Left, V.Left, V.DownLeft, V.Down, V.DownRight, V.Right, V.Right, V.Right, V.DownRight, V.Down, V.DownLeft];
      }
      move() {}
      unlockForNewGame() {
      ...
      update() {
        super.update(), this.updateAngle(), this.updateTimer(), this.updateDistance(), this.updateLineFx(), this.direction === V.Up || this.timer.crash || (this.updateDrift(), this.updateSpeed());
      }
      routeAction(A, t = !1) {
        if (!(this.timer.crash || this.distance.air && A !== z.Down)) switch (A) {
          case z.Up:
            this.up();
            break;
          case z.Down:
      ...
      changeDirection(A, t = !1) {
        ...
        let e;
        switch (t || A !== V.Left ? t || A !== V.Right || (A = this.direction === V.DownRight ? V.Right : V.DownRight) : A = this.direction === V.DownLeft ? V.Left : V.DownLeft, A) {
          case V.Left:
            e = -42;
            break;
          case V.Right:
        ...
        this.direction = A, this.changePose(A), this.drift = e, 0 !== e && 0 !== this.angle || (this.angle = e), this.radian = this.angle * Math.PI / 180;
      }
      changePose(A) {
        this.isFoe && (A = A === V.Up ? V.Crash : V.Chase), this.pose = A;
      }
      updateAngle() {
        this.speed.x = this.speed.current * -Math.cos(this.radian), this.speed.y = this.speed.current * -Math.sin(this.radian);
      }
      updateTimer() {
        this.timer.crash && (this.timer.crash -= hA.sys.game.time.loop * hA.sys.game.time.scale, this.timer.crash <= 0 && (this.timer.crash = void 0, this.endCrash()));
      }
      updateDistance() {
        for (const A in this.distance) this.distance[A] && this.distance.hasOwnProperty(A) && (this.distance[A] -= this.speed.current, this.distance[A] <= 0 && (this.distance[A] = void 0, "boost" === A ? this.endBoost() : "air" === A && this.endAir()));
      }
      updateDrift() {
        if (this.drift === this.angle) return;
        const A = 3600 * hA.sys.game.time.loop / this.speed.current;
        Math.abs(this.drift - this.angle) < A ? this.angle = this.drift : this.angle += this.drift < this.angle ? -A : A, this.radian = this.angle * Math.PI / 180;
      }
      updateSpeed() {
        ...
        this.speed.raw = t.raw <= t.max ? t.raw += e : t.raw -= e, this.speed.current = t.raw * hA.sys.game.time.scale;
      }
      up() {
        this.changeDirection(V.Up), this.stopPlayerSpeed(), j.sys.feedback("tiny");
      }
      down() {
      ...
      crash() {
        this.timer.crash = 1, this.stopPlayerSpeed(), this.distance.immune = 96, this.changePose(V.Crash);
      }
      air(A) {
        this.timer.crash || (this.down(), this.distance.boost && (this.distance.boost += A), this.distance.air = A, this.speed.max = this.speed.base + this.speed.airAdd, this.shadow = 0, this.changePose(V.Air1));
      }
      boost() {
      ...
      endAir() {
        this.distance.immune = 256, this.distance.boost || (this.speed.max = this.speed.base), this.changePose(V.Down), j.sys.reset(), j.sys.feedback("slow");
      }
      endBoost() {
      ...
      changeToFoe() {
        this.isFoe = !0, this.changePose(V.Chase), this.speed.base += 3, this.speed.max = this.speed.base, this.hitbox.x -= 32, this.hitbox.y -= 32, this.hitbox.w += 64, this.hitbox.h += 64;
      }
      spin() {
      ...
      updateLineFx() {
        this.moveLines(this.boostFx, 0.8), this.boostFx = this.boostFx.filter(A => A.time < 0.5), this.distance.boost && this.speed.current > 0 && this.addLine(this.boostFx), this.moveLines(this.driftFx, 1.2), this.driftFx = this.driftFx.filter(A => A.time < 0.5), this.drift !== this.angle && this.speed.current > this.speed.max / 3 && this.addLine(this.driftFx);
      }
      moveLines(A, t) {
        A.length <= 0 || A.forEach(A => {
          A.start.x -= this.speed.x * t, A.end.x -= this.speed.x, A.start.y -= this.speed.y * t, A.end.y -= this.speed.y, A.time += hA.sys.game.time.loop;
        });
      }
      addLine(A) {
      ...
      draw() {
        if (hA.sys.isState(dA.Menu)) this.drawMenu();else if (this.boostFx.length > 0 && X.sys.drawLineFx(this.boostFx, "accent"), this.driftFx.length > 0 && X.sys.drawLineFx(this.driftFx, "fx"), this.isFoe) X.sys.drawLayer("foe", this.pose, this.x, this.y, this.time, this.anim);else {
          if (hA.sys.game.friend && X.sys.drawShield(this.x, this.y + 8), this.distance.air && (this.distance.air < 256 ? this.shadow = this.distance.air / 4 : this.shadow < 64 ? this.shadow += 3 * hA.sys.game.time.scale : this.shadow = 64, X.sys.drawShadow(this.x, this.y + 16, this.shadow)), this.distance.immune) {
    ...
    const P = {
      Endless: {
        ...
        saveScore() {
          ...
          A > hA.sys.highScore.endless && (hA.sys.highScore.endless = A, hA.sys.triggerHighScore());
        },
        buildStartScene() {
          const A = hA.sys.session.x,
        ...
        update() {
          ...
          A && this.buildNextLevel(), t && Z.sys.buildFoe(), e && Z.sys.buildNpc(), s && this.saveScore(), this.checkDistances();
        },
        checkCollisions() {
          J.entity.isFoe ? K.checkFoeObjects() : K.checkPlayerObjects(), K.checkFoeNpcObject(), K.checkPlayerFoes(), K.checkPlayerNpcs();
        },
        collisionEvent(A) {
          switch (A.type) {
            case "trigger":
        ...
        checkDistances() {
          ...
          t && !Z.sys.lairBuilt && Z.sys.buildLair(), !hA.sys.game.highScore && e && this.saveScore();
        },
        checkPass(A) {
          "lure" === A.type && A.hit && A.y + 192 < J.entity.y && (Z.sys.buildObject("foe", A.x, A.y + 32, "chase"), A.sleep = !0);
        },
        buildNextLevel() {
          ...
          if (Z.sys.ready(this.distance.checkpoint)) return void Z.sys.buildCheckpoint(A, t);
          const e = Math.floor(Z.sys.slots / 2);
          for (let s = -e; s <= e; s++) {
            let e = 0,
              n = 0,
              r = "allNormal";
            0 === s ? J.entity.distance.air ? r = "allPassive" : Z.sys.ready(this.distance.life) ? r = "endlessLives" : Z.sys.ready(this.distance.friend) ? r = "endlessFriends" : Z.sys.ready(this.distance.boost) ? r = "endlessBoosts" : Z.sys.ready(this.distance.ramp) ? r = "endlessRamps" : Z.sys.ready(this.distance.lure) && (r = "endlessLures") : (e = i(-5, 5) * Z.sys.grid, n = i(0, 8) * Z.sys.grid);
      ...
      TimeTrial: {
        ...
        setup() {
          this.loadClusters(), this.edge = 576, this.clusters = ["start", "intro", "act1a", "act1b", "act2a", "act2b", "act3a", "act3b", "act4a", "act4b", "act5a", "act5b", "act6a", "act6b", "act7a", "act7b", "finish"];
        },
        reset() {
          this.counter = 0, this.pixels = {
            next: 0,
            add: 1088
          }, this.distance = {
            friend: {
        ...
        saveScore() {
          if (hA.sys.game.cheat.used) return;
          const A = this.getScore();
          A < hA.sys.highScore.timetrial && hA.sys.game.finish && (hA.sys.highScore.timetrial = A, hA.sys.triggerHighScore());
        },
        buildStartScene() {
          this.buildNextLevel();
        },
        update() {
          Z.sys.passed(this.pixels) && this.buildNextLevel(), this.checkDistances();
        },
        checkCollisions() {
        ...
        buildNextLevel() {
          ...
          Z.sys.buildCluster("timetrialScenes", t, e, A), this.counter += 1;
        },
        loadClusters() {
          this.library = {
            timetrialMenu: {
      ...
      ZigZag: {
        ...
        reset() {
          this.counter = 0, this.previousGate = -1, this.pixels = {
            next: 0,
            add: 1200
          }, this.distance = {
            npc: {
        ...
        saveScore() {
          if (hA.sys.game.cheat.used) return;
          const A = this.getScore();
          A > hA.sys.highScore.zigzag && (hA.sys.highScore.zigzag = A, hA.sys.triggerHighScore());
        },
        buildStartScene() {
          const A = hA.sys.session.x,
            t = hA.sys.session.y + 512;
          Z.sys.buildCluster("zigzagGates", A, t, "gateFirst"), this.counter += 1;
        },
        update() {
          Z.sys.passed(this.pixels) && this.buildNextLevel(), Z.sys.ready(this.distance.npc) && Z.sys.buildNpc();
        },
        checkCollisions() {
          K.checkPlayerObjects(), K.checkFoeNpcObject(), K.checkPlayerNpcs();
        },
        collisionEvent(A) {
          switch (A.type) {
            case "marker":
        ...
        checkPass(A) {
          ...
          "gate" !== A.type || t || A.hit || (hA.sys.game.friend ? (this.updateGate(A.gateId), W.removeFriend()) : W.gameLose());
        },
        passGate(A) {
          A - 1 === this.previousGate && (hA.sys.game.gates += 1), this.updateGate(A), this.saveScore();
        },
        updateGate(A) {
          this.previousGate = A;
        },
        buildNextLevel() {
          const A = hA.sys.session.x - hA.sys.game.dist.x,
            ...
            n = e ? A - 320 : A + 320;
          Z.sys.buildCluster("zigzagGates", n, t, s), this.counter += 1, this.createGateClusters(A, t, e);
        },
        createGateClusters(A, t, e) {
          ...
          Z.sys.ready(this.distance.friend) && !hA.sys.game.friend ? n = "friend" : a ? n = "life" : Math.random() < 0.1 ? n = "spiral" : Math.random() < 0.4 && (n = Math.random() > 0.5 ? "slowbig" : "bumpbig"), n && Z.sys.buildObject(n, A, s, n);
          const o = e ? A + 64 : A - 64;
          ...
          Z.sys.buildCluster("allNormal", A - 560, l, r(R.sys.group.small)), Z.sys.buildCluster("allNormal", A + 560, g, r(R.sys.group.small));
        },
        loadClusters() {
          this.library = {
            zigzagMenu: {
      ...
      Collector: {
        ...
        saveScore() {
          if (hA.sys.game.cheat.used) return;
          const A = this.getScore();
          A > hA.sys.highScore.collector && (hA.sys.highScore.collector = A, hA.sys.triggerHighScore());
        },
        buildStartScene() {
          const A = hA.sys.session.x,
        ...
        update() {
          !this.flagScore && hA.sys.game.coins > hA.sys.highScore.collector && (this.saveScore(), this.flagScore = !0);
          const A = Z.sys.passed(this.pixels),
            t = Z.sys.passed(this.distance.save);
          A && this.buildNextLevel(), t && this.saveScore(), Z.sys.ready(this.distance.npc) && Z.sys.buildNpc();
        },
        checkCollisions() {
          K.checkPlayerObjects(), K.checkFoeNpcObject(), K.checkPlayerNpcs(), hA.sys.game.friend && this.coinMagnetCollision();
        },
        coinMagnetCollision() {
          const A = J.entity;
        ...
        buildNextLevel() {
          ...
          Z.sys.ready(this.distance.friend) && !hA.sys.game.friend ? Z.sys.buildCluster("collectorFriends", A, t) : e ? Z.sys.buildCluster("collectorScenes", A, t) : (Z.sys.buildCluster("collectorCoinsOnly", A, t), Z.sys.buildCluster("allNormal", A, t + 256, r(R.sys.group.small)));
        },
        loadClusters() {
          this.library = {
            collectorMenu: {
      ...
      setup() {
        new R(), this.active = this.Endless, this.list = [this.Endless, this.TimeTrial, this.ZigZag, this.Collector], this.list.forEach(A => {
    ...
    parent._handlers["gamemodeRegistered"](new Proxy({}, {
      get(_, prop) {
    ...
    class X {
      constructor() {
        ...
        X.sys = this, this.playerSprite = new Image(), this.bodyColors = ["rgb(85, 49, 23)", "rgb(135, 76, 43)", "rgb(178, 91, 32)", "rgb(204, 125, 54)", "rgb(204, 142, 74)", "rgb(249, 173, 115)", "rgb(255, 209, 166)", "rgb(242, 170, 145)", "rgb(245, 192, 158)"], this.hairColors = ["rgb(66, 55, 55)", "rgb(136, 90, 37)", "rgb(202, 127, 40)", "rgb(254, 211, 80)", "rgb(191, 191, 191)", "rgb(222, 89, 58)", "rgb(227, 93, 174)", "rgb(169, 111, 242)", "rgb(70, 211, 135)"], this.outfitColors = ["rgb(227, 78, 78)", "rgb(191, 102, 233)", "rgb(89, 130, 237)", "rgb(75, 192, 192)", "rgb(146, 206, 69)", "rgb(236, 210, 76)", "rgb(243, 141, 83)", "rgb(232, 232, 232)", "rgb(126, 126, 126)"];
      }
      createPlayerSprite(A) {
        const t = 640,
          e = this.createCanvas(t, 288);
        if (this.applyLayers(e.ctx, q.sys.playerImg, [0, 64, 128], t, 64, 16), "konami" === A) this.applyLayers(e.ctx, q.sys.konamiImg, [0, 0, 0], t, 64, 16);else {
        ...
        s.src = e.canvas.toDataURL("image/png"), (() => {
          ...
          A = this, t = void 0, n = function* () {
            ...
            function o(A) {
              var t;
              A.done ? s(A.value) : (t = A.value, t instanceof e ? t : new e(function (A) {
                A(t);
              })).then(r, a);
            }
      ...
      createPlayerBody(A, t) {
        ...
        return g.ctx.drawImage(q.sys.playerImg, l, 576, r, a, 0, 0, r, a), q.sys.playerSprite.head.forEach(A => {
          e.ctx.drawImage(c.canvas, 0, 0, r, a, A.x, A.y + 16, r, a), e.ctx.drawImage(g.canvas, 0, 0, r, a, A.x, A.y + 16, r, a);
        }), e.canvas;
      }
      colorize(A, t, e, s, n, i) {
        const r = this.createCanvas(n, i);
        r.ctx.drawImage(A, t, e, n, i, 0, 0, n, i), r.ctx.globalCompositeOperation = "source-atop", r.ctx.fillStyle = s, r.ctx.fillRect(0, 0, n, i);
        const a = this.createCanvas(n, i);
        return a.ctx.drawImage(A, t, e, n, i, 0, 0, n, i), a.ctx.globalCompositeOperation = "overlay", a.ctx.drawImage(r.canvas, 0, 0, n, i, 0, 0, n, i), a.ctx.globalCompositeOperation = "source-over", a;
      }
      createCanvas(A, t) {
      ...
      applyLayers(A, t, e, s, n, i = 0) {
        A.drawImage(t, 0, e[0], s, n, 0, 0 + i, s, n), A.drawImage(t, 0, e[1], s, n, 0, n + 3 * i, s, n), A.drawImage(t, 0, e[2], s, n, 0, 2 * n + 5 * i, s, n);
      }
      createGameCanvas(A) {
        this.canvas = A, this.ctx = A.getContext("2d"), this.offset = {
          x: 0,
          y: 0
        }, this.lineDash = {
          crash: [],
      ...
      drawBackground() {
        ...
        this.ctx.save(), this.ctx.fillStyle = this.bg.pattern, this.ctx.translate(-A, -t), this.ctx.fillRect(A, t, hA.sys.session.w, hA.sys.session.h), this.ctx.restore();
      }
      defineCanvas() {
        const A = window.getComputedStyle(this.canvas.parentNode);
        hA.sys.session.w = parseInt(A.getPropertyValue("width"), 10), hA.sys.session.h = parseInt(A.getPropertyValue("height"), 10), this.canvas.style.width = hA.sys.session.w + "px", this.canvas.style.height = hA.sys.session.h + "px", this.canvas.width = hA.sys.session.w, this.canvas.height = hA.sys.session.h, hA.sys.session.x = Math.floor(0.5 * hA.sys.session.w), hA.sys.session.y = Math.floor(0.4 * hA.sys.session.h), this.ctx.imageSmoothingEnabled = !1;
      }
      clearCanvas() {
        this.ctx.clearRect(0, 0, hA.sys.session.w, hA.sys.session.h), this.ctx.lineCap = "round", this.ctx.lineJoin = "round";
      }
      drawFx(A = 0, t = 0, e = 0) {
      ...
      drawLayer(A, t, e = 0, s = 0, n = 0, i = "looping", r) {
        ...
        if (this.draw(q.sys.objectsImg, a, e, s, o[c]), ("oneshot" === i || "ending" === i) && Math.ceil(n * a.fps) > o.length - 1) switch (i) {
          case "oneshot":
            r.anim = "paused";
            break;
          case "ending":
      ...
      drawShadow(A, t, e) {
        const s = X.sys.ctx;
        s.beginPath(), s.arc(A, t + e, 20 - e / 12, 0, 2 * Math.PI), s.fillStyle = "rgba(0,0,0," + (0.6 - e / 200) + ")", s.fill();
      }
      drawLineFx(A, t) {
        const e = X.sys.ctx;
        e.strokeStyle = q.sys[t], A.forEach(A => {
          const t = 0.5 - A.time;
          e.lineWidth = 6 * t, e.beginPath(), e.moveTo(A.start.x, A.start.y), e.lineTo(A.end.x, A.end.y), e.stroke();
        });
      }
      drawShield(A, t) {
        const e = Math.cos(4 * hA.sys.game.time.elapsed) + 3,
          ...
          i = X.sys.ctx;
        i.beginPath(), i.ellipse(A, t, s, 0.7 * s, 0, 0, 2 * Math.PI), i.strokeStyle = q.sys.accent, i.lineWidth = 6 - e, i.stroke(), i.beginPath(), i.ellipse(A, t, n / 2, n / 2 * 0.7, 0, 0, 2 * Math.PI), i.fillStyle = q.sys.accent, i.fill();
      }
      drawPickup(A) {
        ...
        const t = A.time % 1,
          ...
          n = X.sys.ctx;
        n.beginPath(), n.arc(A.x, A.y, e, 0, 2 * Math.PI), n.strokeStyle = q.sys.accent, n.lineWidth = 6 * (1 - t), n.stroke(), n.beginPath(), n.arc(A.x, A.y, s, 0, 2 * Math.PI), n.strokeStyle = q.sys.accent, n.lineWidth = 6 * (1 - 2 * t), n.stroke();
      }
      drawHitbox(A, t) {
        const e = u.sys.sheet[A].str;
        if (!e) return;
        const s = X.sys.ctx;
        s.beginPath(), s.lineWidth = 4, s.strokeStyle = q.sys.hitbox, s.setLineDash(this.lineDash[e]), s.strokeRect(Math.floor(t.x) + 1, Math.floor(t.y) + 1, t.w - 2, t.h - 2), s.setLineDash([]);
      }
      drawBoundaries() {
        const A = hA.sys.session.x - hA.sys.game.dist.x,
          t = X.sys.ctx;
        t.beginPath(), t.rect(0, 0, A - P.active.edge, hA.sys.session.h), t.rect(A + P.active.edge, 0, hA.sys.session.w, hA.sys.session.h), t.fillStyle = q.sys.boundary, t.fill();
      }
      drawScaled(A, t, e, s, n, i = 1) {
        X.sys.ctx.drawImage(A, n.x, n.y, t.w, t.h, Math.floor(e - t.w / (2 / i)), Math.floor(s - t.h / (2 / i)), t.w * i, t.h * i), X.sys.ctx.globalAlpha = 1;
      }
      draw(A, t, e, s, n) {
        X.sys.ctx.drawImage(A, n.x, n.y, t.w, t.h, Math.floor(e - t.w / 2), Math.floor(s - t.h / 2), t.w, t.h), X.sys.ctx.globalAlpha = 1;
      }
    }
    X.sys = null;
    class q {
      ...
      setup() {
        this.list = [this.Horizon, this.Surf], this.list.forEach(A => {
          A.setup();
        }), this.playerSprite = {}, this.activeTheme = this.getTheme(), o(this.activeTheme.playerSprite, this.playerSprite), this.objectsImg = new Image(), this.playerImg = new Image(), this.konamiImg = new Image(), this.bgImg = new Image(), this.bgSize = 256, this.contrast = {
          boundary: "GrayText",
          accent: "LinkText",
          fx: "LinkText",
          hitbox: "CanvasText"
      ...
      getTheme() {
        let A = this.list[0];
        for (let t = 0; t < this.list.length; t++) this.list[t].name === hA.sys.settings.theme && (A = this.list[t]);
        return A;
      }
      cycleTheme(A) {
        const t = this.list,
      ...
      updateTheme(A = this.getTheme()) {
        this.loadNewTheme(A), (() => {
          var t, e, s, n;
          t = this, e = void 0, n = function* () {
            yield this.objectsTemp.decode(), yield this.playerTemp.decode(), yield this.konamiTemp.decode(), yield this.bgTemp.decode(), this.applyTheme(A), this.checkForcedColors();
            ...
            function o(t) {
              var e;
              t.done ? A(t.value) : (e = t.value, e instanceof s ? e : new s(function (A) {
                A(e);
              })).then(r, a);
            }
            o((n = n.apply(t, e || [])).next());
          });
        })(), this.activeTheme = A, hA.sys.settings.theme = this.activeTheme.name, hA.sys.saveSessionSettings();
      }
      checkForcedColors() {
        const A = window.matchMedia("(forced-colors:active)");
        hA.sys.session.contrast = A.matches, hA.sys.session.contrast && (this.hitbox = this.contrast.hitbox, this.boundary = this.contrast.boundary, this.accent = this.contrast.accent, this.fx = this.contrast.fx);
      }
      loadNewTheme(A) {
        this.objectsTemp = new Image(), this.objectsTemp.src = A.imageSource.objects, this.playerTemp = new Image(), this.playerTemp.src = A.imageSource.player, this.konamiTemp = new Image(), this.konamiTemp.src = A.imageSource.konami, this.bgTemp = new Image(), this.bgTemp.src = A.imageSource.bg;
      }
      applyTheme(A) {
        const t = A.gameColor;
        this.objectsImg.src = this.objectsTemp.src, this.playerImg.src = this.playerTemp.src, this.konamiImg.src = this.konamiTemp.src, this.bgImg.src = this.bgTemp.src, this.hitbox = t.hitbox, this.boundary = t.boundary, this.accent = t.accent, this.fx = t.fx, o(A.playerSprite, this.playerSprite), X.sys.createBackground(this.bgImg, this.bgSize), X.sys.createPlayerSprite(), gA.sys.buildIcons(), this.applyRootStyles(), delete this.objectsTemp, delete this.playerTemp, delete this.bgTemp;
      }
      applyRootStyles() {
    ...
    const _ = l(),
      $ = {
        buildMenu() {
          this.buildTopUI(), this.buildHeaderUI(), this.buildModeUI(), this.buildActionUI(), m.show(gA.sys.statsUI);
        },
        buildTopUI() {
          const A = _.getString("gameEditPlayer");
          this.player = m.createIconButton(gA.sys.topLeft, "editPlayer", 1, A), m.clickEvent(this.player, function () {
            gA.sys.changeMenu(gA.sys.Player);
          }, !0);
          const t = _.getString("gameEditTheme");
          this.theme = m.createIconButton(gA.sys.topLeft, "editTheme", 1, t), m.clickEvent(this.theme, function () {
            gA.sys.changeMenu(gA.sys.Theme);
          }, !0);
          const e = _.getString("gameShare");
          gA.sys.buttonShare = m.createIconButton(gA.sys.topRight, "share", 1, e), F.button = gA.sys.buttonShare, m.clickEvent(gA.sys.buttonShare, function () {
            T.sys.toggleFlyout(F);
          });
          const s = _.getString("gameSettings");
          gA.sys.buttonSettings = m.createIconButton(gA.sys.topRight, "settings", 1, s), O.button = gA.sys.buttonSettings, m.clickEvent(gA.sys.buttonSettings, function () {
            T.sys.toggleFlyout(O);
          });
        },
        buildHeaderUI() {
          this.title = m.create("h1", gA.sys.headerUI, "ui-title"), this.refreshHeaderUI();
        },
        refreshHeaderUI() {
        ...
        buildModeUI() {
          ...
          this.modeText = m.create("span", i), m.classAdd(n.parentNode, "focus-group"), this.refreshModeUI();
        },
        refreshModeUI() {
          this.modeTitle.textContent = _.getString(P.active.stringLookup.title), this.modeText.textContent = _.getString(P.active.stringLookup.howto), gA.sys.refreshStatsUI();
        },
        buildActionUI() {
      ...
      tA = {
        buildMenu() {
          this.buildTopUI(), this.buildHeaderUI(), this.buildPreviewUI(), this.buildColorUI(), this.buildActionUI(), this.buildOutfit(), this.storePlayer();
        },
        buildTopUI() {
        ...
        buildHeaderUI() {
          ...
          this.editOutfit = m.createIconButton(A, "editOutfit", 2, t), m.clickEvent(this.editOutfit, function () {
            tA.buildOutfit();
          });
          const e = AA.getString("editPlayerHair");
          this.editHair = m.createIconButton(A, "editHair", 2, e), m.clickEvent(this.editHair, function () {
            tA.buildHair();
          });
          const s = AA.getString("editPlayerBody");
          this.editBody = m.createIconButton(A, "editBody", 2, s), m.clickEvent(this.editBody, function () {
            tA.buildBody();
          });
          const n = AA.getString("editPlayerExtras");
          this.editExtras = m.createIconButton(A, "editExtras", 2, n), m.clickEvent(this.editExtras, function () {
            tA.buildExtras();
        ...
        buildColorUI() {
          this.colorPicker = m.create("div", gA.sys.secondaryUI, "alt-select"), m.classAdd(this.colorPicker, "color-picker"), this.colors = [];
          const A = AA.getString("editPlayerColor");
          for (let t = 0; t < 9; t++) this.colors[t] = m.createButton(this.colorPicker, A, 4), m.classAdd(this.colors[t], "color"), m.clickEvent(this.colors[t], function () {
            tA.changeColor(tA.colors[t]);
          });
          this.activeColor = this.colors[0], m.create("div", this.activeColor, void 0, "check");
          const t = m.createIconSVG(this.activeColor, "checkmark");
          m.classAdd(t, "checkmark"), m.classAdd(this.activeColor, "selected");
        },
        buildActionUI() {
          ...
          m.clickEvent(t, function () {
            var A;
            gA.sys.changeMenu(gA.sys.Main), M(D, Q.CUSTOMIZED_CHARACTER), M("recordBodyColor", g((A = h.data.settings).playerBodyColor, 8)), M("recordHairStyle", g(A.playerHairStyle, 20)), M("recordHairColor", g(A.playerHairColor, 8)), M("recordOutfits", g(A.playerOutfitStyle, 3)), M("recordOutfitColor", g(A.playerOutfitColor, 8)), M("recordAccessory", g(A.playerExtraStyle, 20));
          }, !0), m.focusButton(t);
        },
        refreshUI(A) {
        ...
        changeActive(A) {
          ...
          t && m.classDel(t, "active"), m.classAdd(A, "active"), this.activeSubmenu = A;
        },
        updateButtons(A, t, e) {
        ...
        buildBody() {
          this.changeActive(this.editBody), this.refreshUI("editPlayerBody"), m.hide(gA.sys.primaryUI), m.show(gA.sys.secondaryUI), this.buildColorButtons(X.sys.bodyColors), this.changeColor(this.colors[hA.sys.settings.playerBodyColor]), this.updateButtons(0, 3, 4);
        },
        buildOutfit() {
          this.changeActive(this.editOutfit), this.refreshUI("editPlayerOutfit"), m.show(gA.sys.primaryUI), m.show(gA.sys.secondaryUI), this.buildColorButtons(X.sys.outfitColors), this.changeColor(this.colors[hA.sys.settings.playerOutfitColor]), this.updateButtons(3, 4, 5);
        },
        buildHair() {
          this.changeActive(this.editHair), this.refreshUI("editPlayerHair"), m.show(gA.sys.primaryUI), m.show(gA.sys.secondaryUI), this.buildColorButtons(X.sys.hairColors), this.changeColor(this.colors[hA.sys.settings.playerHairColor]), this.updateButtons(3, 4, 5);
        },
        buildExtras() {
          this.changeActive(this.editExtras), this.refreshUI("editPlayerExtras"), m.show(gA.sys.primaryUI), m.hide(gA.sys.secondaryUI), this.updateButtons(3, 0, 4);
        },
        buildColorButtons(A) {
        ...
        changeColor(A) {
          A.appendChild(this.activeColor.getElementsByTagName("div")[0]), A.appendChild(this.activeColor.getElementsByTagName("svg")[0]), m.classDel(this.activeColor, "selected"), m.classAdd(A, "selected"), this.activeColor = A;
        ...
        revertPlayer() {
          hA.sys.settings.playerBodyColor = this.revert.playerBodyColor, hA.sys.settings.playerHairStyle = this.revert.playerHairStyle, hA.sys.settings.playerHairColor = this.revert.playerHairColor, hA.sys.settings.playerOutfitStyle = this.revert.playerOutfitStyle, hA.sys.settings.playerOutfitColor = this.revert.playerOutfitColor, hA.sys.settings.playerExtraStyle = this.revert.playerExtraStyle, hA.sys.saveSessionSettings(), X.sys.createPlayerSprite();
        }
      },
      eA = l(),
      sA = {
        ...
        buildThemeUI() {
          const A = m.create("div", gA.sys.secondaryUI, "alt-select"),
            ...
            e = m.createIconButton(A, "caretLeft", 2, t);
          m.clickEvent(e, function () {
            q.sys.cycleTheme("prev"), sA.refreshHeaderUI(), sA.refreshThemeUI();
          }), this.altTitle = m.create("span", A);
          const s = eA.getString("actionNext"),
            n = m.createIconButton(A, "caretRight", 2, s);
          m.clickEvent(n, function () {
            q.sys.cycleTheme("next"), sA.refreshHeaderUI(), sA.refreshThemeUI();
          }), m.classAdd(n.parentNode, "focus-group"), this.refreshThemeUI();
        },
        refreshThemeUI() {
          const A = q.sys.list,
      ...
      iA = {
        ...
        buildTopUI() {
          ...
          gA.sys.buttonSettings = m.createIconButton(gA.sys.topRight, "settings", 1, e), O.button = gA.sys.buttonSettings, m.clickEvent(gA.sys.buttonSettings, function () {
            T.sys.toggleFlyout();
          });
        }
      },
      ...
      aA = {
        buildMenu() {
          this.buildTopUI(), this.buildHeaderUI(), this.buildActionUI(), this.buildMenuActionUI(), m.show(gA.sys.statsUI);
        },
        buildTopUI() {
      ...
      cA = {
        buildMenu() {
          this.buildTopUI(), this.buildHeaderUI(), setTimeout(function () {
            cA.buildShareUI();
          }, 100);
        },
        buildTopUI() {
        ...
        buildHeaderUI() {
          ...
          let t = "menuOverTitle";
          hA.sys.game.highScore ? t = "menuOverTitleHighScore" : P.active.almostHighScore() && (t = "menuOverTitleAlt"), A.textContent = oA.getString(t), this.buildScoreMeter(gA.sys.headerUI), this.animateScoreMeter();
        },
        buildShareUI() {
          this.shareAction = m.create("div", gA.sys.actionUI, "share-content"), this.buildActionButton(this.shareAction), this.buildShareRow(this.shareAction);
        },
        buildActionButton(A) {
          const t = oA.getString("menuOverButton"),
            e = gA.sys.buildActionButtonUI(A, "playCircle", 2, t);
          m.classAdd(e, "btn-full"), m.clickEvent(e, function () {
            j.sys.inputToggle();
          }, !0), m.focusButton(e);
        },
        buildScoreMeter(A) {
          this.statsScore = m.create("div", A, void 0, "stats-score"), this.scoreIcon = m.create("span", this.statsScore, void 0, "score-icon"), m.createIconSVG(this.scoreIcon, "star"), m.hide(this.scoreIcon);
          const t = m.create("span", this.statsScore, void 0, "score-meter");
          this.scoreText = m.create("span", t, void 0, "score-text"), this.scoreFill = m.create("span", t, void 0, "score-fill");
        },
        animateScoreMeter() {
          const A = P.active.getScoreFormatted();
          this.scoreText.textContent = A, this.scoreFill.style.transition = "width 0.6s 0.2s", setTimeout(function () {
            const A = P.active.scoreMeter();
            cA.scoreFill.style.width = 100 * A + "%";
          }, 100), hA.sys.game.highScore && (m.show(cA.scoreIcon), m.classAdd(cA.statsScore, "highscore"));
        },
        buildShareRow(A) {
    ...
    class gA {
      constructor() {
        ...
        gA.sys = this, this.Main = $, this.Player = tA, this.Theme = sA, this.Play = iA, this.Pause = aA, this.Over = cA;
      }
      setup() {
        this.active = gA.sys.Main, this.buildContainers(), this.buildCanvas(), this.list = [this.Player, this.Theme], this.list.filter(A => A.menuCluster).forEach(A => {
      ...
      changeMenu(A) {
        ...
        this.clearContainers(), m.hide(this.statsUI), m.hide(this.notifyUI), m.unfocusButton(), this.active.buildMenu(), T.sys.closeAllFlyouts(), this.tintScreen();
      }
      buildCanvas() {
        const A = m.create("canvas", document.body, "game-canvas");
        m.create("div", document.body, "game-color"), X.sys.createGameCanvas(A);
      }
      buildContainers() {
        this.ui = m.create("div", document.body, "game-ui"), this.tint = m.create("div", document.body, "game-tint"), this.topLeft = m.create("nav", this.ui, "top-left", "top-container"), this.topRight = m.create("nav", this.ui, "top-right", "top-container"), this.topRight.setAttribute("aria-label", lA.getString("gameSettings")), this.statsUI = m.create("div", this.ui, "ui-stats"), this.headerUI = m.create("div", this.ui, "ui-header"), this.primaryUI = m.create("div", this.ui, "ui-main"), this.secondaryUI = m.create("div", this.ui, "ui-alt"), this.actionUI = m.create("div", this.ui, "ui-action"), this.clearContainers(), this.notifyUI = m.create("div", this.ui, "ui-notify"), m.hide(this.notifyUI), this.notify = m.create("span", this.notifyUI, "notify-content"), this.buildStatsUI();
      }
      clearContainers() {
        m.clear(this.topLeft), m.clear(this.topRight), m.clear(this.headerUI), m.clear(this.primaryUI), m.clear(this.secondaryUI), m.clear(this.actionUI), m.show(this.primaryUI), m.show(this.secondaryUI), this.buttonShare = void 0, this.buttonSettings = void 0;
      }
      buildStatsUI() {
        this.statsLives = m.create("div", this.statsUI, void 0, "stats-icons");
        const A = m.create("div", this.statsUI, void 0, "stats-score");
        this.scoreIcon = m.create("span", A, void 0, "score-icon"), m.createIconSVG(this.scoreIcon, "star"), m.hide(this.scoreIcon);
        const t = m.create("span", A, void 0, "score-meter");
        this.scoreText = m.create("span", t, void 0, "score-text"), this.scoreFill = m.create("span", t, void 0, "score-fill"), this.statsBoosts = m.create("div", this.statsUI, void 0, "stats-icons");
      }
      buildActionButtonUI(A, t, e, s) {
        const n = m.createIconButton(A, t, e, s);
        return n.id = "action-button", m.create("span", n).textContent = s, n;
      }
      buildIcons() {
        m.clear(this.statsLives), m.clear(this.statsBoosts);
        const A = "url(" + q.sys.objectsImg.src + ")";
        for (let t = 0; t < hA.sys.game.lives.max; t++) m.create("span", this.statsLives).style.backgroundImage = A;
        for (let t = 0; t < hA.sys.game.boosts.max; t++) m.create("span", this.statsBoosts).style.backgroundImage = A;
        this.updateIcons();
      }
      refreshStatsUI() {
      ...
      sendNotification(A, t = 3e3) {
        ...
        switch (A) {
          ...
          default:
            e = "";
          //@inject sendNMod
          parent._handlers["sendNMod"](new Proxy({}, {
            get(_, prop) {
              return eval(prop.toString());
            },
            set(_, prop, value) {
        ...
        this.notify.textContent = e, clearTimeout(this.timer), this.timer = setTimeout(function () {
          m.hide(gA.sys.notifyUI);
        }, t), m.show(this.notifyUI);
      }
      checkHighScore() {
        hA.sys.game.highScore || hA.sys.isState(dA.Menu) ? (m.show(this.scoreIcon), m.classAdd(this.statsUI, "highscore")) : (m.hide(this.scoreIcon), m.classDel(this.statsUI, "highscore"));
      }
      updateScore() {
        let A = 100;
        hA.sys.isState(dA.Menu) ? this.scoreText.textContent = P.active.getHighScoreFormatted() : (this.scoreText.textContent = P.active.getScoreFormatted(), hA.sys.game.highScore || (A = 100 * P.active.scoreMeter())), this.scoreFill.style.width = A + "%";
      }
      updateIcons() {
        let A = [];
        if (hA.sys.game.cheat.lives || hA.sys.game.cheat.safety) A = ["empty", hA.sys.game.cheat.safety ? "shield" : "life-full", "infinite"];else for (let t = 0; t < hA.sys.game.lives.max; t++) t < hA.sys.game.shields.current ? A[t] = "shield" : t < hA.sys.game.lives.current ? A[t] = "life-full" : A[t] = "life-empty";
        let t = [];
        if (hA.sys.game.cheat.boosts) t = ["boost-full", "infinite", "empty"];else for (let A = 0; A < hA.sys.game.boosts.max; A++) {
        ...
        for (let t = 0; t < e.length; t++) e[t].removeAttribute("class"), m.classAdd(e[t], A[t]);
        for (let A = 0; A < s.length; A++) s[A].removeAttribute("class"), m.classAdd(s[A], t[A]);
      }
    }
    var dA;
    gA.sys = null, function (A) {
      A.Menu = "menu", A.Play = "play", A.Pause = "pause", A.Over = "over";
    }(dA || (dA = {}));
    class hA {
      constructor() {
        if (this.game = void 0, hA.sys) return hA.sys;
        hA.sys = this, this.settings = {}, this.highScore = {}, this.session = {
          state: dA.Menu,
          contrast: !1,
          w: 0,
          h: 0,
      ...
      loadSessionSettings() {
        o(h.data.settings, this.settings), o(h.data.highScore, this.highScore);
      }
      saveSessionSettings() {
        o(this.settings, h.data.settings), o(this.highScore, h.data.highScore), h.setData();
      }
      reset() {
        this.game = {
          time: {
      ...
      update(A) {
        this.game.time.loop = A / 1e3, this.game.time.elapsed += this.game.time.loop, this.game.time.scale = 60 * this.game.time.loop * this.settings.gameSpeed;
      }
      updateDistances(A) {
      ...
      triggerHighScore() {
        this.game.highScore || (this.game.highScore = !0, this.saveSessionSettings(), gA.sys.refreshStatsUI(), gA.sys.sendNotification("score"));
      }
      addItem(A, t = 1) {
    ...
    class bA {
      constructor() {
        ...
        bA.sys = this, new hA(), new j(), new q(), new gA(), new T(), new u(), new Z(), new X();
      }
      setup() {
        return A = this, t = void 0, s = function* () {
          yield h.setup(), hA.sys.setup(), P.setup(), j.sys.setup(), q.sys.setup(), gA.sys.setup(), T.sys.setup(), q.sys.updateTheme(), this.reflowCanvas(), new J(), this.changeState(dA.Menu);
      ...
      gameLoop(A) {
        if (j.sys.update(), !hA.sys.isState(dA.Pause)) switch (hA.sys.update(A), hA.sys.getState()) {
          case dA.Play:
            this.updatePlay();
            break;
          case dA.Menu:
      ...
      triggerMenu() {
        P.active.saveScore(), hA.sys.reset(), X.sys.defineCanvas(), X.sys.clearCanvas(), gA.sys.changeMenu(gA.sys.Main), j.sys.reset(), P.reset(), X.sys.createPlayerSprite();
      }
      triggerPlay(A) {
        A === dA.Menu && this.triggerStart(), gA.sys.changeMenu(gA.sys.Play);
      }
      triggerStart() {
        M("recordTheme", function (A) {
          ...
          return -1;
        }(hA.sys.settings.theme)), M("recordGameMode", function (A) {
          switch (A) {
            case "endless":
              return I.Classic;
            case "timetrial":
          ...
          return -1;
        }(P.active.id)), hA.sys.game.time.elapsed = 0, J.entity.unlockForNewGame(), Z.sys.start(), j.sys.feedback("big");
      }
      triggerPause() {
        gA.sys.changeMenu(gA.sys.Pause);
      }
      triggerOver() {
        P.active.saveScore(), Z.sys.all.forEach(A => {
          "ending" === A.anim && (A.sleep = !0);
        }), gA.sys.changeMenu(gA.sys.Over), j.sys.feedback("big");
      }
      updateMenu() {
        Z.sys.all.forEach(A => {
          A.update();
      ...
      updatePlay() {
        K.update(), Z.sys.update(), Z.sys.all.forEach(A => {
          A.update();
        }), Z.sys.all.forEach(A => {
          A.move(J.entity.speed);
        }), gA.sys.updateScore(), hA.sys.updateDistances(J.entity.speed), X.sys.updateBackground(0, 0, J.entity.speed), this.render();
      }
      updateOver() {
      ...
      reflowCanvas() {
        ...
        Z.sys.calcClusterSlots(), Z.sys.all.forEach(A => {
          A.shift(e, s);
      ...
      render() {
        ...
        //@inject beforeRender
        parent._handlers["beforeRender"](new Proxy({}, {
          get(_, prop) {
            return eval(prop.toString());
          },
          set(_, prop, value) {
        ...
        //@inject afterRender
        parent._handlers["afterRender"](new Proxy({}, {
          get(_, prop) {
            return eval(prop.toString());
          },
          set(_, prop, value) {
    ...
    var CA = e(379),
      ...
      EA = e(402),
      DA = {};
    DA.setAttributes = fA(), DA.insert = yA().bind(null, "head"), DA.domAPI = pA(), DA.insertStyleElement = vA(), uA()(EA.Z, DA), EA.Z && EA.Z.locals && EA.Z.locals;
    //@inject ready
    parent._handlers["ready"](new Proxy({}, {
      get(_, prop) {
        return eval(prop.toString());
      },
      set(_, prop, value) {
    ...
    window.addEventListener("DOMContentLoaded", () => {
      !function () {
        ...
        A = this, t = void 0, i = function* () {
          ...
          requestAnimationFrame(t), function (A, t) {
            let e;
            window.addEventListener("resize", function () {
              void 0 !== e && (clearTimeout(e), e = void 0), e = setTimeout(function () {
                e = void 0, A();
              }, t);
            });
          }(function () {
